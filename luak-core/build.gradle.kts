...
val generateBuildInfo = tasks.register("generateBuildInfo") {
    ...
    val output = generatedBuildInfo.map { it.file("org/basaltmc/luak/BuildInfo.kt") }
    outputs.file(output)
...
publishing {
    publications.withType<MavenPublication>().configureEach {
        pom {
            name.set("Luak Core")
            description.set("Kotlin Multiplatform embeddable Lua 5.5 runtime, compiler, and parser.")
