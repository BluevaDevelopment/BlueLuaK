 ...
 * 
 * 
 * Implements the [org.basaltmc.luak.Globals.Compiler] interface for loading
 ...
 * [org.basaltmc.luak.lib.LuaPlatform] and [org.basaltmc.luak.lib.jvm.JvmPlatform] classes,
...
class LuaC protected constructor() : Constants(), Globals.Compiler, Globals.Loader {
    ...
    internal class CompileState {
        ...
        private fun compilerAssert(condition: Boolean) {
            if (!condition) throw org.basaltmc.luak.LuaError("compiler assert failed")
        }
    }

    companion object {
        /** A sharable instance of the LuaC compiler.  */
        val instance: LuaC = org.basaltmc.luak.compiler.LuaC()
        ...
        fun install(globals: Globals) {
            globals.compiler = org.basaltmc.luak.compiler.LuaC.Companion.instance
            globals.loader = org.basaltmc.luak.compiler.LuaC.Companion.instance
        }
    }
}
