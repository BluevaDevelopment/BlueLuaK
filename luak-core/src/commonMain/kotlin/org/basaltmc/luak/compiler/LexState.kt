...
import org.basaltmc.luak.arrayCopy
import org.basaltmc.luak.LocVars
import org.basaltmc.luak.Lua
import org.basaltmc.luak.LuaError
import org.basaltmc.luak.LuaInteger
import org.basaltmc.luak.LuaString
import org.basaltmc.luak.LuaValue
import org.basaltmc.luak.Prototype
import org.basaltmc.luak.compiler.FuncState.BlockCnt
import org.basaltmc.luak.lib.MathLib
import org.basaltmc.luak.io.IOException
import org.basaltmc.luak.io.InputStream
...
internal class LexState internal constructor(state: LuaC.CompileState?, stream: InputStream?) : Constants() {
    ...
    internal class Token {
        var token: Int = 0
        val seminfo: SemInfo = org.basaltmc.luak.compiler.LexState.SemInfo()
        fun set(other: Token) {
    ...
    internal val t: Token = org.basaltmc.luak.compiler.LexState.Token() /* current token */
    internal val lookahead: Token = org.basaltmc.luak.compiler.LexState.Token() /* look ahead token */
    ...
    internal var dyd: Dyndata = org.basaltmc.luak.compiler.LexState.Dyndata() /* dynamic structures used by the parser */
    ...
    fun nextChar() {
        try {
            ...
            e.printStackTrace()
            current = org.basaltmc.luak.compiler.LexState.Companion.EOZ
        }
    }
    ...
    fun token2str(token: Int): String {
        if (token < org.basaltmc.luak.compiler.LexState.Companion.FIRST_RESERVED) {
            return if (org.basaltmc.luak.compiler.LexState.Companion.iscntrl(token)) "'<\\" + token + ">'" else "'" + token.toChar() + "'"
        }
        val text: String = org.basaltmc.luak.compiler.LexState.Companion.luaX_tokens!![token - org.basaltmc.luak.compiler.LexState.Companion.FIRST_RESERVED]!!
        val describes: Boolean = token >= org.basaltmc.luak.compiler.LexState.Companion.TK_EOS && token <= org.basaltmc.luak.compiler.LexState.Companion.TK_STRING
    ...
    fun txtToken(token: Int): String {
        when (token) {
            org.basaltmc.luak.compiler.LexState.Companion.TK_NAME, org.basaltmc.luak.compiler.LexState.Companion.TK_STRING, org.basaltmc.luak.compiler.LexState.Companion.TK_NUMBER ->
    ...
    fun inclinenumber() {
        ...
        if (++linenumber >= org.basaltmc.luak.compiler.LexState.Companion.MAX_INT) syntaxerror("chunk has too many lines")
    }

    internal fun setinput(L: LuaC.CompileState?, firstByte: Int, z: InputStream?, source: LuaString?) {
        this.decpoint = '.'.code.toByte()
        this.L = L
        this.lookahead.token = org.basaltmc.luak.compiler.LexState.Companion.TK_EOS /* no look-ahead token */
        this.z = z
        this.fs = null
        this.linenumber = 1
        this.lastline = 1
    ...
    private fun skipShebang() {
        ...
        if (current == '#'.code) {
            while (!currIsNewline() && current != org.basaltmc.luak.compiler.LexState.Companion.EOZ) nextChar()
        }
    }
	...
	*/
    ...
    internal fun str2d(str: String, seminfo: SemInfo): Boolean {
        ...
        val numeral: LuaValue = org.basaltmc.luak.NumberParser.parse(str.trim())
            ?: run {
                lexerror("malformed number", org.basaltmc.luak.compiler.LexState.Companion.TK_NUMBER)
                return false
            }
        seminfo.r = numeral
        return true
    ...
    internal fun read_long_string(seminfo: SemInfo?, sep: Int) {
        ...
        while (!endloop) {
            when (current) {
                org.basaltmc.luak.compiler.LexState.Companion.EOZ -> lexerror(
                    if (seminfo != null)
                        "unfinished long string"
                    else
                        "unfinished long comment", org.basaltmc.luak.compiler.LexState.Companion.TK_EOS
                )
                ...
                '['.code -> {
                    if (skip_sep() == sep) {
                        save_and_next() /* skip 2nd `[' */
                        cont++
                        if (org.basaltmc.luak.compiler.LexState.Companion.LUA_COMPAT_LSTR == 1) {
                ...
                ']'.code -> {
                    if (skip_sep() == sep) {
                        save_and_next() /* skip 2nd `]' */
                        if (org.basaltmc.luak.compiler.LexState.Companion.LUA_COMPAT_LSTR == 2) {
                            cont--
    ...
    private fun esccheck(ok: Boolean, msg: String) {
        if (!ok) {
            if (current != org.basaltmc.luak.compiler.LexState.Companion.EOZ) save_and_next()
            lexerror(msg, org.basaltmc.luak.compiler.LexState.Companion.TK_STRING)
        }
    }
     ...
     * in [org.basaltmc.luak.lib.Utf8Lib] also produces.
     */
    internal fun readutf8esc() {
        ...
        org.basaltmc.luak.lib.Utf8Lib.encode(value, encoded, 1)
    ...
    internal fun read_string(del: Int, seminfo: SemInfo) {
        ...
        while (current != del) {
            when (current) {
                org.basaltmc.luak.compiler.LexState.Companion.EOZ -> {
                    lexerror("unfinished string", org.basaltmc.luak.compiler.LexState.Companion.TK_EOS)
                    continue  /* to avoid warnings */
                }

                '\n'.code, '\r'.code -> {
                    lexerror("unfinished string", org.basaltmc.luak.compiler.LexState.Companion.TK_STRING)
                    continue  /* to avoid warnings */
                }
                ...
                '\\'.code -> {
                    ...
                    when (current) {
                        ...
                        org.basaltmc.luak.compiler.LexState.Companion.EOZ -> continue  /* will raise an error next loop */
                        'z'.code -> {
                            ...
                            if (!isdigit(current)) {
                                ...
                                esccheck(c <= org.basaltmc.luak.compiler.LexState.Companion.UCHAR_MAX, "decimal escape too large")
        ...
        while (true) {
            when (current) {
                ...
                '['.code -> {
                    run {
                        ...
                        if (sep >= 0) {
                            ...
                            return org.basaltmc.luak.compiler.LexState.Companion.TK_STRING
                        } else if (sep == -1) return '['.code
                        else lexerror(
                            "invalid long string delimiter",
                            org.basaltmc.luak.compiler.LexState.Companion.TK_STRING
                        )
                    }
                    run {
                        nextChar()
                        if (current != '='.code) return '='.code
                            ...
                            nextChar()
                            return org.basaltmc.luak.compiler.LexState.Companion.TK_EQ
                        }
                    }
                }
                ...
                '<'.code -> {
                    ...
                    if (current == '='.code) {
                        nextChar()
                        return org.basaltmc.luak.compiler.LexState.Companion.TK_LE
                    } else if (current == '<'.code) {
                        nextChar()
                        return org.basaltmc.luak.compiler.LexState.Companion.TK_SHL
                    } else return '<'.code
                }
                ...
                '>'.code -> {
                    ...
                    if (current == '='.code) {
                        nextChar()
                        return org.basaltmc.luak.compiler.LexState.Companion.TK_GE
                    } else if (current == '>'.code) {
                        nextChar()
                        return org.basaltmc.luak.compiler.LexState.Companion.TK_SHR
                    } else return '>'.code
                }
                ...
                '/'.code -> {
                    ...
                    if (current != '/'.code) return '/'.code
                        ...
                        nextChar()
                        return org.basaltmc.luak.compiler.LexState.Companion.TK_IDIV
                    }
                }
                ...
                '~'.code -> {
                    ...
                    if (current != '='.code) return '~'.code
                        ...
                        nextChar()
                        return org.basaltmc.luak.compiler.LexState.Companion.TK_NE
                    }
                }
                ...
                ':'.code -> {
                    ...
                    if (current != ':'.code) return ':'.code
                        ...
                        nextChar()
                        return org.basaltmc.luak.compiler.LexState.Companion.TK_DBCOLON
                    }
                }
                ...
                '.'.code -> {
                    save_and_next()
                    if (check_next(".")) {
                        if (check_next(".")) return org.basaltmc.luak.compiler.LexState.Companion.TK_DOTS /* ... */
                        else return org.basaltmc.luak.compiler.LexState.Companion.TK_CONCAT /* .. */
                    } else if (!isdigit(current)) return '.'.code
                    else {
                        read_numeral(seminfo)
                        return org.basaltmc.luak.compiler.LexState.Companion.TK_NUMBER
                    }
                }
                ...
                org.basaltmc.luak.compiler.LexState.Companion.EOZ -> {
                    return org.basaltmc.luak.compiler.LexState.Companion.TK_EOS
                }
                    ...
                    if (isalpha(current) || current == '_'.code) {
                        ...
                        if (org.basaltmc.luak.compiler.LexState.Companion.RESERVED.containsKey(ts)) return org.basaltmc.luak.compiler.LexState.Companion.RESERVED[
                            ts
                        ]!!
                        else {
                            seminfo.ts = ts
                            return org.basaltmc.luak.compiler.LexState.Companion.TK_NAME
                        }
                    } else {
                        val c = current
                        nextChar()
    ...
    fun next() {
        lastline = linenumber
        if (lookahead.token != org.basaltmc.luak.compiler.LexState.Companion.TK_EOS) { /* is there a look-ahead token? */
            t.set(lookahead) /* use this one */
            lookahead.token = org.basaltmc.luak.compiler.LexState.Companion.TK_EOS /* and discharge it */
        } else t.token = llex(t.seminfo) /* read next token */
    }

    fun lookahead() {
        _assert(lookahead.token == org.basaltmc.luak.compiler.LexState.Companion.TK_EOS)
    ...
    internal class expdesc {
        ...
        val u: U = org.basaltmc.luak.compiler.LexState.expdesc.U()
        ...
        fun init(k: Int, i: Int) {
            this.f.i = org.basaltmc.luak.compiler.LexState.Companion.NO_JUMP
            this.t.i = org.basaltmc.luak.compiler.LexState.Companion.NO_JUMP
            this.k = k
            this.u.info = i
        ...
        fun isnumeral(): Boolean {
            return (k == org.basaltmc.luak.compiler.LexState.Companion.VKNUM && t.i === org.basaltmc.luak.compiler.LexState.Companion.NO_JUMP && f.i === org.basaltmc.luak.compiler.LexState.Companion.NO_JUMP)
        }
    ...
    internal class Vardesc(idx: Int) {
        ...
        var kind: Int = org.basaltmc.luak.compiler.LexState.Companion.VDKREG
    ...
    fun hasmultret(k: Int): Boolean {
        return ((k) == org.basaltmc.luak.compiler.LexState.Companion.VCALL || (k) == org.basaltmc.luak.compiler.LexState.Companion.VVARARG)
    }
    ...
    fun anchor_token() {
        ...
        _assert(fs != null || t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_EOS)
        if (t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_NAME || t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_STRING) {
    ...
    fun str_checkname(): LuaString? {
        val ts: LuaString?
        check(org.basaltmc.luak.compiler.LexState.Companion.TK_NAME)
        ts = t.seminfo.ts
        next()
        return ts
    }
    ...
    internal fun codestring(e: expdesc, s: LuaString?) {
        e.init(org.basaltmc.luak.compiler.LexState.Companion.VK, fs!!.stringK(s))
    }
    ...
    fun new_localvar(name: LuaString?) {
        ...
        dyd.actvar!![dyd.n_actvar++] = org.basaltmc.luak.compiler.LexState.Vardesc(reg)
    }
    ...
    internal fun buildvar(varname: LuaString, `var`: expdesc) {
        ...
        if (resolved != org.basaltmc.luak.compiler.LexState.Companion.VVOID) return
    ...
    private fun buildglobal(varname: LuaString, `var`: expdesc) {
        val fs: FuncState = this.fs!!
        val key: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        val search = FuncState.Globalsearch()
        ...
        if (FuncState.singlevaraux(fs, (this.envn)!!, `var`, 1, search) ==
            org.basaltmc.luak.compiler.LexState.Companion.VVOID
        ) {
            this.semerror(
    ...
    internal fun adjust_assign(nvars: Int, nexps: Int, e: expdesc) {
        ...
        if (hasmultret(e.k)) {
            ...
            if (e.k != org.basaltmc.luak.compiler.LexState.Companion.VVOID) fs.exp2nextreg(e)
            if (extra > 0) {
    ...
    fun enterlevel() {
        if (++L!!.nCcalls > org.basaltmc.luak.compiler.LexState.Companion.LUAI_MAXCCALLS) lexerror(
    ...
    internal fun newlabelentry(l: Array<Labeldesc?>, index: Int, name: LuaString?, line: Int, pc: Int): Int {
        l[index] = org.basaltmc.luak.compiler.LexState.Labeldesc(
            name,
            pc,
            line,
            fs!!.nactvar,
	...
	*/
    internal fun undefgoto(gt: Labeldesc) {
        val msg: String? = L!!.pushfstring(
            if (org.basaltmc.luak.compiler.LexState.Companion.isReservedKeyword(gt.name!!.tojstring()))
    ...
    internal fun codeclosure(v: expdesc) {
        ...
        v.init(org.basaltmc.luak.compiler.LexState.Companion.VRELOCABLE, fs.codeABx(OP_CLOSURE, 0, fs.np - 1))
    ...
    internal fun open_func(fs: FuncState, bl: BlockCnt?) {
        ...
        fs.pc = 0
        fs.lasttarget = -1
        fs.jpc = IntPtr(org.basaltmc.luak.compiler.LexState.Companion.NO_JUMP)
        fs.freereg = 0
        fs.nk = 0
        fs.np = 0
        fs.nups = 0
	...
	*/
    internal class ConsControl {
        var v: expdesc = org.basaltmc.luak.compiler.LexState.expdesc() /* last list item read */
    ...
    internal fun recfield(cc: ConsControl) {
        ...
        val key: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        val `val`: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        val rkkey: Int
        if (this.t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_NAME) {
            fs!!.checklimit(cc.nh, org.basaltmc.luak.compiler.LexState.Companion.MAX_INT, "items in a constructor")
            this.checkname(key)
        } else  /* this.t.token == '[' */
            this.yindex(key)
        cc.nh++
    ...
    internal fun listfield(cc: ConsControl) {
        this.expr(cc.v)
        fs!!.checklimit(cc.na, org.basaltmc.luak.compiler.LexState.Companion.MAX_INT, "items in a constructor")
        cc.na++
        cc.tostore++
    }
    ...
    internal fun constructor(t: expdesc) {
        ...
        val cc: ConsControl = org.basaltmc.luak.compiler.LexState.ConsControl()
        cc.tostore = 0
        cc.nh = cc.tostore
        cc.na = cc.nh
        cc.t = t
        t.init(org.basaltmc.luak.compiler.LexState.Companion.VRELOCABLE, pc)
        cc.v.init(org.basaltmc.luak.compiler.LexState.Companion.VVOID, 0) /* no value (yet) */
        fs.exp2nextreg(t) /* fix it at stack top (for gc) */
        this.checknext('{'.code)
        do {
            _assert(cc.v.k == org.basaltmc.luak.compiler.LexState.Companion.VVOID || cc.tostore > 0)
            if (this.t.token == '}'.code) break
            fs.closelistfield(cc)
            when (this.t.token) {
                org.basaltmc.luak.compiler.LexState.Companion.TK_NAME -> {
        ...
        SETARG_B(i, org.basaltmc.luak.compiler.LexState.Companion.luaO_int2fb(cc.na)) /* set initial array size */
        SETARG_C(i, org.basaltmc.luak.compiler.LexState.Companion.luaO_int2fb(cc.nh)) /* set initial table size */
    }
        ...
        if (this.t.token != ')'.code) {  /* is `parlist' not empty? */
            do {
                when (this.t.token) {
                    ...
                    org.basaltmc.luak.compiler.LexState.Companion.TK_DOTS -> {
                        /* param . `...' or `...NAME' */
                        this.next()
                        f.is_vararg = 1
                        if (this.t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_NAME) {
                            ...
                            this.dyd!!.actvar!![this.dyd!!.n_actvar - 1]!!.kind =
                                org.basaltmc.luak.compiler.LexState.Companion.RDKCONST
                            ...
                            this.new_localvarliteral(
                                org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_VARARGS,
                            )
                        }
                    }

                    else -> this.syntaxerror("<name> or " + org.basaltmc.luak.compiler.LexState.Companion.LUA_QL("...") + " expected")
                }
    ...
    internal fun body(e: expdesc, needself: Boolean, line: Int) {
        ...
        this.check_match(
            org.basaltmc.luak.compiler.LexState.Companion.TK_END,
            org.basaltmc.luak.compiler.LexState.Companion.TK_FUNCTION,
            line
        )
        this.codeclosure(e)
        this.close_func()
    ...
    internal fun funcargs(f: expdesc) {
        ...
        val args: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        val base: Int
        val nparams: Int
        when (this.t.token) {
            '('.code -> {
                ...
                if (this.t.token == ')'.code)  /* arg list is empty? */
                    args.k = org.basaltmc.luak.compiler.LexState.Companion.VVOID
                else {
                    this.explist(args)
                    fs.setmultret(args)
                }
        ...
        _assert(f.k == org.basaltmc.luak.compiler.LexState.Companion.VNONRELOC)
        base = f.u.info /* base register for call */
        if (hasmultret(args.k)) nparams = Lua.LUA_MULTRET /* open call */
        else {
            if (args.k != org.basaltmc.luak.compiler.LexState.Companion.VVOID) fs.exp2nextreg(args) /* close last argument */
            nparams = fs.freereg - (base + 1)
        }
        f.init(org.basaltmc.luak.compiler.LexState.Companion.VCALL, fs.codeABC(Lua.OP_CALL, base, nparams + 1, 2))
        fs.fixline(line)
	...
	*/
    ...
    internal fun suffixedexp(v: expdesc) {
        ...
        while (true) {
            when (t.token) {
                ...
                '('.code, org.basaltmc.luak.compiler.LexState.Companion.TK_STRING, '{'.code -> {
                    /* funcargs */
                    fs!!.exp2nextreg(v)
                    this.funcargs(v)
                }
    ...
    internal fun simpleexp(v: expdesc) {
		 ...
		 */
        when (this.t.token) {
            org.basaltmc.luak.compiler.LexState.Companion.TK_NUMBER -> {
                v.init(org.basaltmc.luak.compiler.LexState.Companion.VKNUM, 0)
            ...
            org.basaltmc.luak.compiler.LexState.Companion.TK_NIL -> {
                v.init(org.basaltmc.luak.compiler.LexState.Companion.VNIL, 0)
            }

            org.basaltmc.luak.compiler.LexState.Companion.TK_TRUE -> {
                v.init(org.basaltmc.luak.compiler.LexState.Companion.VTRUE, 0)
            }

            org.basaltmc.luak.compiler.LexState.Companion.TK_FALSE -> {
                v.init(org.basaltmc.luak.compiler.LexState.Companion.VFALSE, 0)
            }
            ...
            org.basaltmc.luak.compiler.LexState.Companion.TK_DOTS -> {
                ...
                this.check_condition(
                    fs.f!!.is_vararg !== 0, ("cannot use " + org.basaltmc.luak.compiler.LexState.Companion.LUA_QL("...")
                            + " outside a vararg function")
                )
                v.init(org.basaltmc.luak.compiler.LexState.Companion.VVARARG, fs.codeABC(Lua.OP_VARARG, 0, 1, 0))
            }
    ...
    fun getunopr(op: Int): Int {
        when (op) {
            org.basaltmc.luak.compiler.LexState.Companion.TK_NOT -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_NOT
            '-'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_MINUS
            '#'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_LEN
            '~'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_BNOT
            else -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_NOUNOPR
        }
    }
    ...
    fun getbinopr(op: Int): Int {
        when (op) {
            '+'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_ADD
            '-'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_SUB
            '*'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_MUL
            '/'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_DIV
            org.basaltmc.luak.compiler.LexState.Companion.TK_IDIV -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_IDIV
            '&'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_BAND
            '|'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_BOR
            '~'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_BXOR
            org.basaltmc.luak.compiler.LexState.Companion.TK_SHL -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_SHL
            org.basaltmc.luak.compiler.LexState.Companion.TK_SHR -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_SHR
            '%'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_MOD
            '^'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_POW
            org.basaltmc.luak.compiler.LexState.Companion.TK_CONCAT -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_CONCAT
            org.basaltmc.luak.compiler.LexState.Companion.TK_NE -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_NE
            org.basaltmc.luak.compiler.LexState.Companion.TK_EQ -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_EQ
            '<'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_LT
            org.basaltmc.luak.compiler.LexState.Companion.TK_LE -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_LE
            '>'.code -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_GT
            org.basaltmc.luak.compiler.LexState.Companion.TK_GE -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_GE
            org.basaltmc.luak.compiler.LexState.Companion.TK_AND -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_AND
            org.basaltmc.luak.compiler.LexState.Companion.TK_OR -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_OR
            else -> return org.basaltmc.luak.compiler.LexState.Companion.OPR_NOBINOPR
        }
    }
	...
	*/
    internal fun subexpr(v: expdesc, limit: Int): Int {
        ...
        if (uop != org.basaltmc.luak.compiler.LexState.Companion.OPR_NOUNOPR) {
            val line = linenumber
            this.next()
            this.subexpr(v, org.basaltmc.luak.compiler.LexState.Companion.UNARY_PRIORITY)
            fs!!.prefix(uop, v, line)
        } else this.simpleexp(v)
        /* expand while operators have priorities higher than `limit' */
        op = getbinopr(this.t.token)
        while (op != org.basaltmc.luak.compiler.LexState.Companion.OPR_NOBINOPR && org.basaltmc.luak.compiler.LexState.Companion.priority[op]!!.left > limit) {
            val v2: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
            val line = linenumber
            this.next()
            fs!!.infix(op, v)
            /* read sub-expression with higher priority */
            val nextop = this.subexpr(v2, org.basaltmc.luak.compiler.LexState.Companion.priority[op]!!.right.toInt())
	...
	*/
    fun block_follow(withuntil: Boolean): Boolean {
        when (t.token) {
            org.basaltmc.luak.compiler.LexState.Companion.TK_ELSE, org.basaltmc.luak.compiler.LexState.Companion.TK_ELSEIF, org.basaltmc.luak.compiler.LexState.Companion.TK_END, org.basaltmc.luak.compiler.LexState.Companion.TK_EOS -> return true
            org.basaltmc.luak.compiler.LexState.Companion.TK_UNTIL -> return withuntil
            else -> return false
        }
    }
	...
	*/
    internal class LHS_assign {
        ...
        var v: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
    }
	...
	*/
    internal fun check_conflict(lh: LHS_assign?, v: expdesc) {
        ...
        var conflict = false
        while (lh != null) {
            if (lh.v.k == org.basaltmc.luak.compiler.LexState.Companion.VINDEXED) {
                /* table is the upvalue/local being assigned now? */
                if (lh.v.u.ind_vt.toInt() == v.k && lh.v.u.ind_t.toInt() == v.u.info) {
                    conflict = true
                    lh.v.u.ind_vt = org.basaltmc.luak.compiler.LexState.Companion.VLOCAL.toShort()
                    lh.v.u.ind_t = extra /* previous assignment will use safe copy */
                }
                /* index is the local being assigned? (index cannot be upvalue) */
                if (v.k == org.basaltmc.luak.compiler.LexState.Companion.VLOCAL && lh.v.u.ind_idx.toInt() == v.u.info) {
                    conflict = true
        ...
        if (conflict) {
            ...
            val op: Int =
                if (v.k == org.basaltmc.luak.compiler.LexState.Companion.VLOCAL) Lua.OP_MOVE else Lua.OP_GETUPVAL
    ...
    internal fun assignment(lh: LHS_assign, nvars: Int) {
        val e: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        this.check_condition(
            org.basaltmc.luak.compiler.LexState.Companion.VLOCAL <= lh.v.k && lh.v.k <= org.basaltmc.luak.compiler.LexState.Companion.VINDEXED,
            "syntax error"
        )
        this.check_readonly(lh.v)
        if (this.testnext(','.code)) {  /* assignment -> `,' primaryexp assignment */
            val nv: LHS_assign = org.basaltmc.luak.compiler.LexState.LHS_assign()
            nv.prev = lh
            this.suffixedexp(nv.v)
            if (nv.v.k != org.basaltmc.luak.compiler.LexState.Companion.VINDEXED) this.check_conflict(lh, nv.v)
        ...
        e.init(org.basaltmc.luak.compiler.LexState.Companion.VNONRELOC, this.fs!!.freereg - 1) /* default assignment */
        fs!!.storevar(lh.v, e)
    }
    ...
    fun cond(): Int {
        /* cond -> exp */
        val v: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        /* read condition */
        this.expr(v)
        /* `falses' are all equal here */
        if (v.k == org.basaltmc.luak.compiler.LexState.Companion.VNIL) v.k =
            org.basaltmc.luak.compiler.LexState.Companion.VFALSE
        fs!!.goiftrue(v)
        return v.f.i
    }
    ...
    fun gotostat(pc: Int) {
        ...
        val label: LuaString?
        val g: Int
        if (testnext(org.basaltmc.luak.compiler.LexState.Companion.TK_GOTO)) label = str_checkname()
        else {
            next() /* skip break */
    ...
    fun skipnoopstat() {
        while (t.token == ';'.code || t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_DBCOLON) statement()
    }
    ...
    fun labelstat(label: LuaString?, line: Int) {
        ...
        checknext(org.basaltmc.luak.compiler.LexState.Companion.TK_DBCOLON) /* skip double colon */
    ...
    fun whilestat(line: Int) {
        ...
        this.checknext(org.basaltmc.luak.compiler.LexState.Companion.TK_DO)
        this.block()
        fs.patchlist(fs.jump(), whileinit)
        this.check_match(
            org.basaltmc.luak.compiler.LexState.Companion.TK_END,
            org.basaltmc.luak.compiler.LexState.Companion.TK_WHILE,
            line
        )
        fs.leaveblock()
    ...
    fun repeatstat(line: Int) {
        ...
        this.statlist()
        this.check_match(
            org.basaltmc.luak.compiler.LexState.Companion.TK_UNTIL,
            org.basaltmc.luak.compiler.LexState.Companion.TK_REPEAT,
            line
        )
    ...
    fun forbody(base: Int, line: Int, nvars: Int, isnum: Boolean) {
        ...
        prep = if (isnum) fs.codeAsBx(
            Lua.OP_FORPREP,
            base,
            org.basaltmc.luak.compiler.LexState.Companion.NO_JUMP
        ) else fs.jump()
        ...
        if (isnum)  /* numeric for? */
            endfor = fs.codeAsBx(Lua.OP_FORLOOP, base, org.basaltmc.luak.compiler.LexState.Companion.NO_JUMP)
        else {  /* generic for */
            fs.codeABC(Lua.OP_TFORCALL, base, 0, nvars)
            fs.fixline(line)
            endfor = fs.codeAsBx(Lua.OP_TFORLOOP, base + 2, org.basaltmc.luak.compiler.LexState.Companion.NO_JUMP)
        }
    ...
    fun fornum(varname: LuaString?, line: Int) {
        ...
        this.new_localvarliteral(org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_INDEX)
        this.new_localvarliteral(org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_LIMIT)
        this.new_localvarliteral(org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_STEP)
        this.new_varkind(varname, org.basaltmc.luak.compiler.LexState.Companion.RDKCONST)
        this.checknext('='.code)
    ...
    fun forlist(indexname: LuaString?) {
        ...
        this.new_localvarliteral(org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_GENERATOR)
        this.new_localvarliteral(org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_STATE)
        this.new_localvarliteral(org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_CONTROL)
        this.new_localvarliteral(org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_CLOSING)
        /* create declared variables */
        // The first one is the control variable, which the loop overwrites
        // every pass, so Lua 5.5 refuses an assignment to it.
        this.new_varkind(indexname, org.basaltmc.luak.compiler.LexState.Companion.RDKCONST)
        while (this.testnext(','.code)) {
            this.new_localvar(this.str_checkname())
            ++nvars
        }
        this.checknext(org.basaltmc.luak.compiler.LexState.Companion.TK_IN)
    ...
    fun forstat(line: Int) {
        ...
        when (this.t.token) {
            ...
            ','.code, org.basaltmc.luak.compiler.LexState.Companion.TK_IN -> this.forlist(varname)
            else -> this.syntaxerror(
                org.basaltmc.luak.compiler.LexState.Companion.LUA_QL("=")
                    .toString() + " or " + org.basaltmc.luak.compiler.LexState.Companion.LUA_QL("in") + " expected"
            )
        }
        this.check_match(
            org.basaltmc.luak.compiler.LexState.Companion.TK_END,
            org.basaltmc.luak.compiler.LexState.Companion.TK_FOR,
            line
        )
    ...
    fun test_then_block(escapelist: IntPtr?) {
        ...
        if (v.k == org.basaltmc.luak.compiler.LexState.Companion.VNIL) v.k = org.basaltmc.luak.compiler.LexState.Companion.VFALSE /* 'falses' are all equal here */
        fs!!.goiftrue(v)
        val condtrue: Int = v.f.i
        this.checknext(org.basaltmc.luak.compiler.LexState.Companion.TK_THEN)
        this.block() /* 'then' part */
        if (t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_ELSE || t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_ELSEIF) {
    ...
    fun ifstat(line: Int) {
        val escapelist: IntPtr =
            IntPtr(org.basaltmc.luak.compiler.LexState.Companion.NO_JUMP) /* exit list for finished parts */
        test_then_block(escapelist) /* IF cond THEN block */
        while (t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_ELSEIF) test_then_block(escapelist) /* ELSEIF cond THEN block */
        if (testnext(org.basaltmc.luak.compiler.LexState.Companion.TK_ELSE)) block() /* `else' part */
        check_match(
            org.basaltmc.luak.compiler.LexState.Companion.TK_END,
            org.basaltmc.luak.compiler.LexState.Companion.TK_IF,
            line
        )
    ...
    fun localfunc() {
        val b: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        val fs: FuncState = this.fs!!
        this.new_localvar(this.str_checkname())
        this.adjustlocalvars(1)
    ...
    fun localstat() {
        ...
        val defaultkind: Int = this.getlocalattribute(org.basaltmc.luak.compiler.LexState.Companion.VDKREG)
        do {
            this.new_localvar(this.str_checkname())
            val kind = this.getlocalattribute(defaultkind)
            this.dyd!!.actvar!![this.dyd!!.n_actvar - 1]!!.kind = kind
            if (kind == org.basaltmc.luak.compiler.LexState.Companion.RDKTOCLOSE) {
        ...
        if (this.testnext('='.code)) nexps = this.explist(e)
            ...
            e.k = org.basaltmc.luak.compiler.LexState.Companion.VVOID
            nexps = 0
        }
        this.adjust_assign(nvars, nexps, e)
        this.adjustlocalvars(nvars)
    ...
    private fun startsglobalstat(): Boolean {
        ...
        return next == '<'.code || next == '*'.code ||
            next == org.basaltmc.luak.compiler.LexState.Companion.TK_NAME ||
            next == org.basaltmc.luak.compiler.LexState.Companion.TK_FUNCTION
    }
    ...
    internal fun globalstatfunc(line: Int) {
        ...
        if (this.testnext(org.basaltmc.luak.compiler.LexState.Companion.TK_FUNCTION)) this.globalfunc(line)
    ...
    private fun globalstat() {
        val fs: FuncState = this.fs!!
        /* an attribute before the names is the default for all of them */
        val defaultkind: Int = this.getglobalattribute(org.basaltmc.luak.compiler.LexState.Companion.VDKREG)
        if (this.testnext('*'.code)) {
            fs.globals.add(
                FuncState.Globaldesc(
                    null,
                    defaultkind == org.basaltmc.luak.compiler.LexState.Companion.RDKCONST,
                    fs.nactvar.toInt(),
                ),
            )
            return
        ...
        do {
            ...
            names.add(varname)
            readonly.add(kind == org.basaltmc.luak.compiler.LexState.Companion.RDKCONST)
        } while (this.testnext(','.code))
    ...
    private fun initglobal(names: ArrayList<LuaString>, index: Int, line: Int) {
        ...
        val fs: FuncState = this.fs!!
        val target: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        this.buildglobal(names[index], target)
        this.enterlevel()
        this.initglobal(names, index + 1, line)
        this.leavelevel()
        this.checkglobal(names[index], line)
        val value: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        value.init(org.basaltmc.luak.compiler.LexState.Companion.VNONRELOC, fs.freereg - 1)
    ...
    private fun checkglobal(varname: LuaString, line: Int) {
        val fs: FuncState = this.fs!!
        val `var`: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        this.buildglobal(varname, `var`)
    ...
    internal fun getlocalattribute(default: Int): Int {
        if (this.testnext('<'.code)) {
            ...
            this.checknext('>'.code)
            if ("const" == attribute) return org.basaltmc.luak.compiler.LexState.Companion.RDKCONST
            if ("close" == attribute) return org.basaltmc.luak.compiler.LexState.Companion.RDKTOCLOSE
            this.lexerror("unknown attribute '" + attribute + "'", org.basaltmc.luak.compiler.LexState.Companion.TK_NAME)
        }
        return default
    }
    ...
    internal fun check_readonly(e: expdesc) {
        ...
        if (e.k == org.basaltmc.luak.compiler.LexState.Companion.VUPVAL) {
            // The same variable seen from an inner function.
            val up = this.fs?.f?.upvalues?.getOrNull(e.u.info) ?: return
            if (up.kind != org.basaltmc.luak.compiler.LexState.Companion.VDKREG) {
                this.semerror(
        ...
        if (e.k != org.basaltmc.luak.compiler.LexState.Companion.VLOCAL) return
        val fs: FuncState = this.fs!!
        ...
        if (kind == org.basaltmc.luak.compiler.LexState.Companion.RDKCONST ||
            kind == org.basaltmc.luak.compiler.LexState.Companion.RDKTOCLOSE
        ) {
    ...
    fun exprstat() {
        ...
        val fs: FuncState = this.fs!!
        val v: LHS_assign = org.basaltmc.luak.compiler.LexState.LHS_assign()
        this.suffixedexp(v.v)
        if (t.token == '='.code || t.token == ','.code) { /* stat -> assignment ? */
            v.prev = null
            assignment(v, 1)
        } else {  /* stat -> func */
            check_condition(v.v.k == org.basaltmc.luak.compiler.LexState.Companion.VCALL, "syntax error")
    ...
    fun retstat() {
        ...
        if (block_follow(true) || this.t.token == ';'.code) {
            ...
            if (hasmultret(e.k)) {
                ...
                if (e.k == org.basaltmc.luak.compiler.LexState.Companion.VCALL && nret == 1 &&
                    !fs.bl!!.insidetbc
                ) { /* tail call? */
    ...
    fun statement() {
        ...
        when (this.t.token) {
            ...
            org.basaltmc.luak.compiler.LexState.Companion.TK_DO -> {
                /* stat -> DO block END */
                this.next() /* skip DO */
                this.block()
                this.check_match(
            ...
            org.basaltmc.luak.compiler.LexState.Companion.TK_LOCAL -> {
                /* stat -> localstat */
                this.next() /* skip LOCAL */
                if (this.testnext(org.basaltmc.luak.compiler.LexState.Companion.TK_FUNCTION))  /* local function? */
                    this.localfunc()
                else this.localstat()
            }

            org.basaltmc.luak.compiler.LexState.Companion.TK_DBCOLON -> {
                /* stat -> label */
                next() /* skip double colon */
                labelstat(str_checkname(), line)
            }

            org.basaltmc.luak.compiler.LexState.Companion.TK_RETURN -> {
                /* stat -> retstat */
                next() /* skip RETURN */
                this.retstat()
            }

            org.basaltmc.luak.compiler.LexState.Companion.TK_BREAK, org.basaltmc.luak.compiler.LexState.Companion.TK_GOTO -> {
                /* stat -> breakstat */
    ...
    fun statlist() {
        ...
        while (!block_follow(true)) {
            if (t.token == org.basaltmc.luak.compiler.LexState.Companion.TK_RETURN) {
                statement()
	...
	*/
    internal fun mainfunc(funcstate: FuncState) {
        ...
        val v: expdesc = org.basaltmc.luak.compiler.LexState.expdesc()
        v.init(org.basaltmc.luak.compiler.LexState.Companion.VLOCAL, 0) /* create and... */
        fs!!.newupvalue(envn, v) /* ...set environment upvalue */
        next() /* read first token */
        statlist() /* parse main body */
        check(org.basaltmc.luak.compiler.LexState.Companion.TK_EOS)
        close_func()
    } /* }====================================================================== */
    ...
    companion object {
        ...
        protected val RESERVED_LOCAL_VAR_KEYWORDS: Array<String?> = arrayOf<String?>(
            org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_CONTROL,
            org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_CLOSING,
            org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_GENERATOR,
            org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_INDEX,
            org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_LIMIT,
            org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_STATE,
            org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_FOR_STEP
        )
        private val RESERVED_LOCAL_VAR_KEYWORDS_TABLE: HashMap<String?, Boolean> = HashMap()

        init {
            for (i in org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_KEYWORDS.indices) org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_KEYWORDS_TABLE!!.put(
                org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_KEYWORDS[i],
                true
            )
        }
        ...
        private fun LUA_QL(o: Any?): String {
            return org.basaltmc.luak.compiler.LexState.Companion.LUA_QS((o).toString())
        }
        ...
        fun isReservedKeyword(varName: String?): Boolean {
            return org.basaltmc.luak.compiler.LexState.Companion.RESERVED_LOCAL_VAR_KEYWORDS_TABLE.containsKey(varName)
        }
	...
	*/
        ...
        val FIRST_RESERVED: Int = org.basaltmc.luak.compiler.LexState.Companion.TK_AND
        val NUM_RESERVED: Int =
            org.basaltmc.luak.compiler.LexState.Companion.TK_WHILE + 1 - org.basaltmc.luak.compiler.LexState.Companion.FIRST_RESERVED

        val RESERVED: HashMap<LuaString?, Int> = HashMap()

        init {
            for (i in 0..<org.basaltmc.luak.compiler.LexState.Companion.NUM_RESERVED) {
                val ts: LuaString? =
                    LuaValue.valueOf(org.basaltmc.luak.compiler.LexState.Companion.luaX_tokens!![i]) as LuaString?
                org.basaltmc.luak.compiler.LexState.Companion.RESERVED!!.put(
                    ts,
                    org.basaltmc.luak.compiler.LexState.Companion.FIRST_RESERVED + i
                )
            }
        }
        ...
        fun vkisvar(k: Int): Boolean {
            return (org.basaltmc.luak.compiler.LexState.Companion.VLOCAL <= (k) && (k) <= org.basaltmc.luak.compiler.LexState.Companion.VINDEXED)
        }

        fun vkisinreg(k: Int): Boolean {
            return ((k) == org.basaltmc.luak.compiler.LexState.Companion.VNONRELOC || (k) == org.basaltmc.luak.compiler.LexState.Companion.VLOCAL)
        }
	...
	*/
        ...
        internal var priority: Array<Priority?> =
            arrayOf<Priority?>( /* ORDER OPR */org.basaltmc.luak.compiler.LexState.Priority(10, 10),
                org.basaltmc.luak.compiler.LexState.Priority(10, 10),  /* `+' `-' */
                org.basaltmc.luak.compiler.LexState.Priority(11, 11),
                org.basaltmc.luak.compiler.LexState.Priority(11, 11),
                org.basaltmc.luak.compiler.LexState.Priority(11, 11),  /* `*' `/' `%' */
                org.basaltmc.luak.compiler.LexState.Priority(14, 13),
                org.basaltmc.luak.compiler.LexState.Priority(9, 8),  /* power and concat (right associative) */
                org.basaltmc.luak.compiler.LexState.Priority(3, 3),
                org.basaltmc.luak.compiler.LexState.Priority(3, 3),  /* equality and inequality */
                org.basaltmc.luak.compiler.LexState.Priority(3, 3),
                org.basaltmc.luak.compiler.LexState.Priority(3, 3),
                org.basaltmc.luak.compiler.LexState.Priority(3, 3),
                org.basaltmc.luak.compiler.LexState.Priority(3, 3),  /* order */
                org.basaltmc.luak.compiler.LexState.Priority(2, 2),
                org.basaltmc.luak.compiler.LexState.Priority(1, 1),  /* logical (and/or) */
                org.basaltmc.luak.compiler.LexState.Priority(11, 11),  /* `//' */
                org.basaltmc.luak.compiler.LexState.Priority(6, 6),  /* `&' */
                org.basaltmc.luak.compiler.LexState.Priority(4, 4),  /* `|' */
                org.basaltmc.luak.compiler.LexState.Priority(5, 5),  /* `~' */
                org.basaltmc.luak.compiler.LexState.Priority(7, 7),
                org.basaltmc.luak.compiler.LexState.Priority(7, 7) /* `<<' `>>' */
            )
