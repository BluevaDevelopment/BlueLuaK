 ...
 * See [org.basaltmc.luak.lib.LuaPlatform] and [org.basaltmc.luak.lib.jvm.JvmPlatform] for details.
 * 
 * 
 ...
 * 
 * @see org.basaltmc.luak.lib.LuaPlatform
 * 
 * @see LoadState
 * 
 * @see Varargs
...
open class LuaValue : Varargs() {
    ...
    open fun tonumber(): LuaValue {
        return org.basaltmc.luak.LuaValue.Companion.NIL
    }
    ...
    internal fun argtypename(): String {
        ...
        if (mt != null) {
            val name: LuaValue = mt.rawget(org.basaltmc.luak.LuaValue.Companion.NAME)
            if (name.type() == org.basaltmc.luak.LuaValue.Companion.TSTRING) return name.tojstring()
        }
    ...
    open fun get(key: LuaValue): LuaValue {
        return org.basaltmc.luak.LuaValue.Companion.gettable(this, key)
    }
    ...
    open fun get(key: String?): LuaValue? {
        return get(org.basaltmc.luak.LuaValue.Companion.valueOf(key))
    }
    ...
    open fun set(key: LuaValue?, value: LuaValue?) {
        org.basaltmc.luak.LuaValue.Companion.settable(this, key, value)
    }
    ...
    open fun set(key: Int, value: String?) {
        set(key, org.basaltmc.luak.LuaValue.Companion.valueOf(value))
    }
    ...
    open fun set(key: String?, value: LuaValue?) {
        set(org.basaltmc.luak.LuaValue.Companion.valueOf(key), value)
    }
    ...
    open fun set(key: String?, value: Double) {
        set(org.basaltmc.luak.LuaValue.Companion.valueOf(key), org.basaltmc.luak.LuaValue.Companion.valueOf(value))
    }
    ...
    open fun rawget(key: Int): LuaValue? {
        return rawget(org.basaltmc.luak.LuaValue.Companion.valueOf(key))
    }
    ...
    open fun rawset(key: Int, value: LuaValue?) {
        rawset(org.basaltmc.luak.LuaValue.Companion.valueOf(key), value)
    }
    ...
    fun rawset(key: Int, value: String?) {
        rawset(key, org.basaltmc.luak.LuaValue.Companion.valueOf(value))
    }
    ...
    fun rawset(key: String?, value: Double) {
        rawset(org.basaltmc.luak.LuaValue.Companion.valueOf(key), org.basaltmc.luak.LuaValue.Companion.valueOf(value))
    }
    ...
    open fun load(library: LuaValue): LuaValue {
        return library.call(org.basaltmc.luak.LuaValue.Companion.EMPTYSTRING, this)!!
    }

    // varargs references
    override fun arg(index: Int): LuaValue {
        return if (index == 1) this else org.basaltmc.luak.LuaValue.Companion.NIL
    }
    ...
    open fun call(): LuaValue? {
        return invoke(org.basaltmc.luak.LuaValue.Companion.NONE!!).arg1()!!
    }
    ...
    open fun call(arg: String?): LuaValue? {
        return call(org.basaltmc.luak.LuaValue.Companion.valueOf(arg))
    }
    ...
    open fun call(arg1: LuaValue?, arg2: LuaValue?): LuaValue? {
        return invoke(org.basaltmc.luak.LuaValue.Companion.varargsOf(arg1, arg2!!)).arg1()!!
    }
    ...
    open fun call(arg1: LuaValue?, arg2: LuaValue?, arg3: LuaValue?): LuaValue? {
        return invoke(
            org.basaltmc.luak.LuaValue.Companion.varargsOf(arrayOf<LuaValue?>(arg1, arg2, arg3)),
        ).arg1()!!
    }
    ...
    open fun invoke(): Varargs {
        return invoke((org.basaltmc.luak.LuaValue.Companion.NONE)!!)
    }
    ...
    open fun invoke(args: Varargs): Varargs {
        ...
        for (self in prefix) all = org.basaltmc.luak.LuaValue.Companion.varargsOf(self, all)
    ...
    open fun invoke(arg: LuaValue?, varargs: Varargs): Varargs {
        return invoke((org.basaltmc.luak.LuaValue.Companion.varargsOf(arg, varargs))!!)
    }
    ...
    open fun invoke(arg1: LuaValue?, arg2: LuaValue?, varargs: Varargs): Varargs {
        return invoke(org.basaltmc.luak.LuaValue.Companion.varargsOf(arg1, arg2, varargs))
    }
    ...
    open fun invoke(args: Array<LuaValue?>): Varargs {
        return invoke((org.basaltmc.luak.LuaValue.Companion.varargsOf(args))!!)
    }
    ...
    open fun invoke(args: Array<LuaValue?>, varargs: Varargs): Varargs {
        return invoke((org.basaltmc.luak.LuaValue.Companion.varargsOf(args, varargs))!!)
    }
    ...
    fun invokemethod(name: String?, args: Varargs): Varargs? {
        return get(name)!!.invoke((org.basaltmc.luak.LuaValue.Companion.varargsOf(this, args))!!)
    }
    ...
    fun invokemethod(name: String?, args: Array<LuaValue?>): Varargs? {
        return get(name)!!.invoke(
            org.basaltmc.luak.LuaValue.Companion.varargsOf(
                this,
                org.basaltmc.luak.LuaValue.Companion.varargsOf(args)
            )
        )
    }
    ...
    internal fun resolvecall(prefix: ArrayList<LuaValue>): LuaValue {
        ...
        while (target !is LuaFunction) {
            val handler: LuaValue = target.metatag(org.basaltmc.luak.LuaValue.Companion.CALL)
            // Nothing to call: reported against the value as it was written.
            if (handler.isnil()) target.callmt()
            if (++depth > org.basaltmc.luak.LuaValue.Companion.MAX_CALL_CHAIN) {
                org.basaltmc.luak.LuaValue.Companion.error("'__call' chain too long")
            }
            prefix.add(target)
            target = handler
        }
    ...
    protected fun callmt(): LuaValue {
        return checkmetatag(org.basaltmc.luak.LuaValue.Companion.CALL, "attempt to call ")
    }
    ...
    open fun not(): LuaValue? {
        return org.basaltmc.luak.LuaValue.Companion.FALSE
    }
    ...
    open fun neg(): LuaValue {
        ...
        return checkmetatag(
            org.basaltmc.luak.LuaValue.Companion.UNM,
    ...
    open fun len(): LuaValue {
        // Lua hands a unary operator its operand twice.
        return checkmetatag(org.basaltmc.luak.LuaValue.Companion.LEN, "attempt to get length of ").call(this, this)!!
    }
    ...
    open fun eq(`val`: LuaValue?): LuaValue? {
        return if (eq_b(`val`)) org.basaltmc.luak.LuaValue.Companion.TRUE else org.basaltmc.luak.LuaValue.Companion.FALSE
    }
    ...
    fun neq(`val`: LuaValue?): LuaValue? {
        return if (eq_b(`val`)) org.basaltmc.luak.LuaValue.Companion.FALSE else org.basaltmc.luak.LuaValue.Companion.TRUE
    }
    ...
    open fun add(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.ADD, rhs)
    }
    ...
    open fun add(rhs: Double): LuaValue {
        return arithmtwith(org.basaltmc.luak.LuaValue.Companion.ADD, rhs)
    }
    ...
    open fun sub(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.SUB, rhs)
    }
    ...
    open fun subFrom(lhs: Double): LuaValue {
        return arithmtwith(org.basaltmc.luak.LuaValue.Companion.SUB, lhs)
    }
    ...
    open fun mul(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.MUL, rhs)
    }
    ...
    open fun mul(rhs: Double): LuaValue {
        return arithmtwith(org.basaltmc.luak.LuaValue.Companion.MUL, rhs)
    }
    ...
    open fun pow(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.POW, rhs)
    }
    ...
    open fun powWith(lhs: Double): LuaValue {
        return arithmtwith(org.basaltmc.luak.LuaValue.Companion.POW, lhs)
    }
    ...
    open fun div(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.DIV, rhs)
    }
    ...
    open fun idiv(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.IDIV, rhs)
    }
    ...
    open fun band(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.BAND, rhs)
    }
    ...
    open fun bor(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.BOR, rhs)
    }
    ...
    open fun bxor(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.BXOR, rhs)
    }
    ...
    open fun shl(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.SHL, rhs)
    }
    ...
    open fun shr(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.SHR, rhs)
    }
    ...
    open fun bnot(): LuaValue {
        val h: LuaValue = metatag(org.basaltmc.luak.LuaValue.Companion.BNOT)
        if (h.isnil()) {
            org.basaltmc.luak.LuaValue.Companion.operandError(
                org.basaltmc.luak.LuaValue.Companion.BNOT,
                this,
                this,
            )
        }
        // Lua hands a unary operator its operand twice.
        checkcallable(org.basaltmc.luak.LuaValue.Companion.BNOT, h)
    ...
    open fun divInto(lhs: Double): LuaValue {
        return arithmtwith(org.basaltmc.luak.LuaValue.Companion.DIV, lhs)
    }
    ...
    open fun mod(rhs: LuaValue): LuaValue {
        return arithmt(org.basaltmc.luak.LuaValue.Companion.MOD, rhs)
    }
    ...
    open fun modFrom(lhs: Double): LuaValue {
        return arithmtwith(org.basaltmc.luak.LuaValue.Companion.MOD, lhs)
    }
    ...
    protected fun arithmt(tag: LuaValue?, op2: LuaValue): LuaValue {
        ...
        if (h.isnil()) {
            h = op2.metatag(tag)
            if (h.isnil()) org.basaltmc.luak.LuaValue.Companion.operandError(tag, this, op2)
        }
        checkcallable(tag, h)
    ...
    internal fun ordererror(op1: LuaValue, op2: LuaValue): LuaValue? {
        ...
        return if (first == second) {
            org.basaltmc.luak.LuaValue.Companion.error("attempt to compare two " + first + " values")
        } else {
            org.basaltmc.luak.LuaValue.Companion.error("attempt to compare " + first + " with " + second)
        }
    }

    internal fun checkcallable(tag: LuaValue?, h: LuaValue) {
        if (h.isfunction()) return
        if (!h.metatag(org.basaltmc.luak.LuaValue.Companion.CALL).isnil()) return
        org.basaltmc.luak.LuaValue.Companion.error(
    ...
    protected fun arithmtwith(tag: LuaValue?, op1: Long): LuaValue {
        ...
        if (h.isnil()) {
            org.basaltmc.luak.LuaValue.Companion.operandError(
                tag,
                org.basaltmc.luak.LuaValue.Companion.valueOf(op1),
                this,
            )
        }
        checkcallable(tag, h)
        return h.call(org.basaltmc.luak.LuaValue.Companion.valueOf(op1), this)!!
    }
    ...
    open fun lt(rhs: LuaValue): LuaValue? {
        return comparemt(org.basaltmc.luak.LuaValue.Companion.LT, rhs)
    }
    ...
    open fun lt_b(rhs: LuaValue): Boolean {
        return comparemt(org.basaltmc.luak.LuaValue.Companion.LT, rhs)!!.toboolean()
    }
    ...
    open fun lteq(rhs: LuaValue): LuaValue? {
        return comparemt(org.basaltmc.luak.LuaValue.Companion.LE, rhs)
    }
    ...
    open fun lteq_b(rhs: LuaValue): Boolean {
        return comparemt(org.basaltmc.luak.LuaValue.Companion.LE, rhs)!!.toboolean()
    }
    ...
    open fun gt(rhs: LuaValue): LuaValue? {
        return rhs.comparemt(org.basaltmc.luak.LuaValue.Companion.LE, this)
    }
    ...
    open fun gt_b(rhs: LuaValue): Boolean {
        return rhs.comparemt(org.basaltmc.luak.LuaValue.Companion.LE, this)!!.toboolean()
    }
    ...
    open fun gteq(rhs: LuaValue): LuaValue? {
        return rhs.comparemt(org.basaltmc.luak.LuaValue.Companion.LT, this)
    }
    ...
    open fun gteq(rhs: Long): LuaValue? {
        return org.basaltmc.luak.LuaValue.Companion.valueOf(todouble() >= rhs)
    }
    ...
    open fun gteq_b(rhs: LuaValue): Boolean {
        return rhs.comparemt(org.basaltmc.luak.LuaValue.Companion.LT, this)!!.toboolean()
    }
    ...
    fun comparemt(tag: LuaValue?, op1: LuaValue): LuaValue? {
        ...
        if (org.basaltmc.luak.LuaValue.Companion.LE.raweq(tag) && (!(metatag(org.basaltmc.luak.LuaValue.Companion.LT).also {
                h = it
            }).isnil() || !(op1.metatag(org.basaltmc.luak.LuaValue.Companion.LT)
                .also { h = it }).isnil())
        ) {
            checkcallable(org.basaltmc.luak.LuaValue.Companion.LT, h!!)
    ...
    open fun strcmp(rhs: LuaValue?): Int {
        org.basaltmc.luak.LuaValue.Companion.error("attempt to compare " + typename())
        return 0
    }
    ...
    fun concatmt(rhs: LuaValue): LuaValue {
        var h = metatag(org.basaltmc.luak.LuaValue.Companion.CONCAT)
        if (h.isnil() && (rhs.metatag(org.basaltmc.luak.LuaValue.Companion.CONCAT)
                .also { h = it }).isnil()
        ) {
        ...
        checkcallable(org.basaltmc.luak.LuaValue.Companion.CONCAT, h)
    ...
    fun metatag(tag: LuaValue?): LuaValue {
        val mt = getmetatable()
        if (mt == null) return org.basaltmc.luak.LuaValue.Companion.NIL
    ...
    private fun indexerror(key: String?) {
        org.basaltmc.luak.LuaValue.Companion.error("attempt to index a " + objtypename() + " value")
    }
    ...
    private class None : LuaNil() {
        ...
        override fun subargs(start: Int): Varargs? {
            return if (start > 0) this else org.basaltmc.luak.LuaValue.Companion.argerror(1, "start must be > 0")
        }
        ...
        override fun copyto(dest: Array<LuaValue?>, offset: Int, length: Int) {
            ...
            var length = length
            while (length > 0) {
                dest[offset++] = org.basaltmc.luak.LuaValue.Companion.NIL
                length--
            }
        }

        companion object {
            var _NONE: None = org.basaltmc.luak.LuaValue.None()
        }
    }
    ...
    override fun subargs(start: Int): Varargs? {
        ...
        if (start > 1) return org.basaltmc.luak.LuaValue.Companion.NONE
        return org.basaltmc.luak.LuaValue.Companion.argerror(1, "start must be > 0")
    }
    ...
    companion object {
        ...
        @kotlin.jvm.JvmField
        val NONE: LuaValue? = org.basaltmc.luak.LuaValue.None.Companion._NONE
         ...
         */
        val NILS: Array<LuaValue?> = arrayOfNulls<LuaValue>(org.basaltmc.luak.LuaValue.Companion.MAXSTACK)

        init {
            for (i in 0..<org.basaltmc.luak.LuaValue.Companion.MAXSTACK) org.basaltmc.luak.LuaValue.Companion.NILS[i] =
                org.basaltmc.luak.LuaValue.Companion.NIL
        }
        ...
        fun operandError(tag: LuaValue?, op1: LuaValue, op2: LuaValue): Nothing {
            val bitwise: Boolean = tag != null && (
                tag == org.basaltmc.luak.LuaValue.Companion.BAND ||
                    tag == org.basaltmc.luak.LuaValue.Companion.BOR ||
                    tag == org.basaltmc.luak.LuaValue.Companion.BXOR ||
                    tag == org.basaltmc.luak.LuaValue.Companion.SHL ||
                    tag == org.basaltmc.luak.LuaValue.Companion.SHR ||
                    tag == org.basaltmc.luak.LuaValue.Companion.BNOT
                )
            val what: String = if (bitwise) "perform bitwise operation on" else "perform arithmetic on"
            val culprit: LuaValue =
                if (op1.type() != org.basaltmc.luak.LuaValue.Companion.TNUMBER) op1 else op2
            org.basaltmc.luak.LuaValue.Companion.error(
        ...
        fun eqmtcall(lhs: LuaValue, rhs: LuaValue): Boolean {
            var h: LuaValue = lhs.metatag(org.basaltmc.luak.LuaValue.Companion.EQ)
            if (h.isnil()) h = rhs.metatag(org.basaltmc.luak.LuaValue.Companion.EQ)
            if (h.isnil()) return false
            h.checkcallable(org.basaltmc.luak.LuaValue.Companion.EQ, h)
         ...
         */
            ...
            return if (b) org.basaltmc.luak.LuaValue.Companion.TRUE else org.basaltmc.luak.LuaValue.Companion.FALSE
        }
        ...
        internal fun gettable(t: LuaValue, key: LuaValue): LuaValue {
            ...
            do {
                if (t.istable()) {
                    ...
                    if ((!res.isnil()) || (t.metatag(org.basaltmc.luak.LuaValue.Companion.INDEX)
                            .also { tm = it }).isnil()
                    ) return res
                } else if ((t.metatag(org.basaltmc.luak.LuaValue.Companion.INDEX).also { tm = it }).isnil()) t.indexerror(
                    key.tojstring()
                )
                if (tm!!.isfunction()) return tm.call(t, key)!!
                t = tm
            } while (++loop < org.basaltmc.luak.LuaValue.Companion.MAXTAGLOOP)
            org.basaltmc.luak.LuaValue.Companion.error("loop in gettable")
            return org.basaltmc.luak.LuaValue.Companion.NIL
        }
        ...
        fun settable(t: LuaValue, key: LuaValue?, value: LuaValue?): Boolean {
            ...
            do {
                if (t.istable()) {
                    if ((!t.rawget(key).isnil()) || (t.metatag(org.basaltmc.luak.LuaValue.Companion.NEWINDEX)
                            .also { tm = it }).isnil()
                    ) {
                        t.rawset(key, value)
                        return true
                    }
                } else if ((t.metatag(org.basaltmc.luak.LuaValue.Companion.NEWINDEX)
                        .also { tm = it }).isnil()
            ...
            org.basaltmc.luak.LuaValue.Companion.error("loop in settable")
            return false
        }
        ...
        internal fun metatableOf(mt: LuaValue?): Metatable? {
            if (mt != null && mt.istable()) {
                val mode: LuaValue = mt.rawget(org.basaltmc.luak.LuaValue.Companion.MODE)
                if (mode.isstring()) {
        ...
        fun varargsOf(v: Array<out LuaValue?>): Varargs {
            when (v.size) {
                0 -> return org.basaltmc.luak.LuaValue.Companion.NONE!!
                1 -> return v[0]!!
                2 -> return PairVarargs(v[0], (v[1])!!)
                else -> return ArrayVarargs(v, (org.basaltmc.luak.LuaValue.Companion.NONE)!!)
            }
        }
        ...
        fun varargsOf(v: Array<out LuaValue?>, offset: Int, length: Int): Varargs {
            when (length) {
                ...
                else -> return ArrayPartVarargs(v, offset, length, (org.basaltmc.luak.LuaValue.Companion.NONE)!!)
            }
        }
