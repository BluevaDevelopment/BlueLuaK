 ...
 * via a [org.basaltmc.luak.Globals.Compiler] such as [org.basaltmc.luak.luajc.LuaJC],
 * this cannot be done in all cases.
 * 
 * 
 * Typically, this library is included as part of a call to
 * [org.basaltmc.luak.lib.jvm.JvmPlatform.debugGlobals] or
 * [org.basaltmc.luak.lib.LuaPlatform.debugGlobals]
...
class DebugLib : TwoArgFunction() {
    ...
    override fun call(modname: LuaValue?, env: LuaValue?): LuaValue? {
        ...
        debug.set("debug", org.basaltmc.luak.lib.DebugLib.debug())
        debug.set("gethook", gethook())
        debug.set("getinfo", getinfo())
        debug.set("getlocal", getlocal())
        debug.set("getmetatable", org.basaltmc.luak.lib.DebugLib.getmetatable())
        debug.set("getregistry", getregistry())
        debug.set("getupvalue", org.basaltmc.luak.lib.DebugLib.getupvalue())
        debug.set("getuservalue", org.basaltmc.luak.lib.DebugLib.getuservalue())
        debug.set("sethook", sethook())
        debug.set("setlocal", setlocal())
        debug.set("setmetatable", org.basaltmc.luak.lib.DebugLib.setmetatable())
        debug.set("setupvalue", org.basaltmc.luak.lib.DebugLib.setupvalue())
        debug.set("setuservalue", org.basaltmc.luak.lib.DebugLib.setuservalue())
        debug.set("traceback", traceback())
        debug.set("upvalueid", org.basaltmc.luak.lib.DebugLib.upvalueid())
        debug.set("upvaluejoin", org.basaltmc.luak.lib.DebugLib.upvaluejoin())
        env!!.set("debug", debug)
    ...
    internal inner class getinfo : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            if (what.indexOf('S') >= 0) {
                ...
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.WHAT, valueOf(ar.what))
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.SOURCE, valueOf(ar.source))
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.SHORT_SRC, valueOf(ar.short_src))
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.LINEDEFINED, valueOf(ar.linedefined))
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.LASTLINEDEFINED, valueOf(ar.lastlinedefined))
            }
            if (what.indexOf('l') >= 0) {
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.CURRENTLINE, valueOf(ar.currentline))
            }
            if (what.indexOf('u') >= 0) {
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.NUPS, valueOf(ar.nups.toInt()))
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.NPARAMS, valueOf(ar.nparams.toInt()))
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.ISVARARG, valueOf(ar.isvararg)!!)
            }
            if (what.indexOf('n') >= 0) {
                ...
                if (named != null) {
                    info.set(org.basaltmc.luak.lib.DebugLib.Companion.NAME, LuaValue.valueOf(named))
                }
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.NAMEWHAT, LuaValue.valueOf(ar.namewhat))
            }
            if (what.indexOf('r') >= 0) {
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.FTRANSFER, valueOf(ar.ftransfer))
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.NTRANSFER, valueOf(ar.ntransfer))
            }
            if (what.indexOf('t') >= 0) {
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.ISTAILCALL, valueOf(ar.istailcall)!!)
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.EXTRAARGS, valueOf(ar.extraargs))
            }
            ...
            if (what.indexOf('L') >= 0 && func != null && func.isclosure()) {
                ...
                info.set(org.basaltmc.luak.lib.DebugLib.Companion.ACTIVELINES, lines)
            }
            if (what.indexOf('f') >= 0) {
                if (func != null) info.set(org.basaltmc.luak.lib.DebugLib.Companion.FUNC, func)
            }
            return info
        }
    }
    ...
    fun registry(): LuaTable {
        ...
        made.set(org.basaltmc.luak.lib.DebugLib.Companion.HOOKKEY!!, hooks)
        registryTable = made
        return made
    }
    ...
    private fun hooks(): LuaTable =
        registry().get(org.basaltmc.luak.lib.DebugLib.Companion.HOOKKEY!!)!! as LuaTable
    ...
    internal class getupvalue : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            if (func is LuaClosure) {
                ...
                val name: LuaString? = org.basaltmc.luak.lib.DebugLib.Companion.findupvalue(c, up)
                if (name != null) {
    ...
    fun onCall(f: LuaFunction?, args: Array<LuaValue?>?) {
        ...
        if (!s.inhook && s.hookcall) {
            callHook(
                s,
                if (tail) org.basaltmc.luak.lib.DebugLib.Companion.TAILCALL
                else org.basaltmc.luak.lib.DebugLib.Companion.CALL,
                NIL,
            )
        }
    }
    ...
    fun onInstruction(pc: Int, v: Varargs?, top: Int) {
        ...
        if (s.hookcount > 0) if (++s.bytecodes % s.hookcount === 0) callHook(
            s,
            org.basaltmc.luak.lib.DebugLib.Companion.COUNT,
            NIL
        )
        if (s.hookline) {
            val frames: CallStack = callstack()
            ...
            if (frame != null && frame.reachedNewLine()) {
                ...
                callHook(
                    s,
                    org.basaltmc.luak.lib.DebugLib.Companion.LINE,
    ...
    fun onReturn() {
        ...
        if (!s.inhook && s.hookrtrn) callHook(s, org.basaltmc.luak.lib.DebugLib.Companion.RETURN, NIL)
        callstack().onReturn()
    }
    ...
    fun callstack(t: LuaThread = globals!!.running): CallStack {
        if (t.callstack == null) {
            val made = org.basaltmc.luak.lib.DebugLib.CallStack()
    ...
    class CallStack internal constructor() {
        ...
        var frame: Array<CallFrame?>? = org.basaltmc.luak.lib.DebugLib.CallStack.Companion.EMPTY
        var calls: Int = 0
        ...
        var owner: DebugLib? = null
            ...
            if (calls >= frame!!.size) {
                ...
                for (i in frame!!.size..<n) f[i] = org.basaltmc.luak.lib.DebugLib.CallFrame()
                frame = f
        ...
        fun tracebacklines(level: Int): List<String> {
            ...
            val ar: DebugInfo = org.basaltmc.luak.lib.DebugLib.DebugInfo()
            var i = 0
                    ...
                    'n' -> {
                        ...
                        if (ci != null && ci.hooked) {
                            ...
                            if (ci.previous!!.f!!.isclosure()) {
                                val nw: NameWhat? = org.basaltmc.luak.lib.DebugLib.Companion.getfuncname(ci.previous!!)
                                if (nw != null) {
                                    ar.name = nw.name
    ...
    class CallFrame {
        ...
        fun instr(pc: Int, v: Varargs?, top: Int) {
            ...
            this.v = v
            this.top = top
            if (org.basaltmc.luak.lib.DebugLib.Companion.TRACE) Print.printState((f!!.checkclosure())!!, pc, stack!!, top, v)
        }
    ...
    companion object {
        ...
        init {
            try {
                org.basaltmc.luak.lib.DebugLib.Companion.CALLS = (null != platformProperty("CALLS"))
            } catch (e: Exception) {
            }
            try {
                org.basaltmc.luak.lib.DebugLib.Companion.TRACE = (null != platformProperty("TRACE"))
            } catch (e: Exception) {
            }
        }
        ...
        fun getfuncname(frame: CallFrame): NameWhat? {
            if (!frame.f!!.isclosure()) return org.basaltmc.luak.lib.DebugLib.NameWhat(frame.f!!.classnamestub(), "Java")
            val p: Prototype = frame.f!!.checkclosure()!!.p
            val pc = frame.pc
            val i: Int = p.code!![pc] /* calling instruction */
            val tm: LuaString
            when (Lua.GET_OPCODE(i)) {
                Lua.OP_CALL, Lua.OP_TAILCALL -> return org.basaltmc.luak.lib.DebugLib.Companion.getobjname(
                    p,
                    pc,
                    Lua.GETARG_A(i)
                )
                ...
                Lua.OP_TFORCALL -> return org.basaltmc.luak.lib.DebugLib.NameWhat("for iterator", "for iterator")
            ...
            return org.basaltmc.luak.lib.DebugLib.NameWhat(tm.tojstring().substring(2), "metamethod")
        }
        ...
        fun getobjname(p: Prototype, lastpc: Int, reg: Int): NameWhat? {
            ...
            if (name != null)  /* is a local? */
                return org.basaltmc.luak.lib.DebugLib.NameWhat(name.tojstring(), "local")

            /* else try symbolic execution */
            pc = org.basaltmc.luak.lib.DebugLib.Companion.findsetreg(p, lastpc, reg)
            if (pc != -1) { /* could find instruction? */
                ...
                when (Lua.GET_OPCODE(i)) {
                    Lua.OP_MOVE -> {
                        ...
                        if (b < a) return org.basaltmc.luak.lib.DebugLib.Companion.getobjname(
                            p,
                            pc,
                            b
                        ) /* get name for `b' */
                    ...
                    Lua.OP_GETTABUP, Lua.OP_GETTABLE -> {
                        ...
                        val vn: LuaString? = if (Lua.GET_OPCODE(i) === Lua.OP_GETTABLE)
                            ...
                            (if (t < p.upvalues!!.size) p.upvalues!![t]!!.name else org.basaltmc.luak.lib.DebugLib.Companion.QMARK)
                        val jname: String = org.basaltmc.luak.lib.DebugLib.Companion.kname(p, pc, k)
                        return org.basaltmc.luak.lib.DebugLib.NameWhat(
                            jname,
                    ...
                    Lua.OP_GETUPVAL -> {
                        ...
                        name =
                            if (u < p.upvalues!!.size) p.upvalues!![u]!!.name else org.basaltmc.luak.lib.DebugLib.Companion.QMARK
                        return if (name == null) null else org.basaltmc.luak.lib.DebugLib.NameWhat(
                            name.tojstring(),
                            "upvalue"
                        )
                    }
                    ...
                    Lua.OP_LOADK, Lua.OP_LOADKX -> {
                        ...
                        if (p.k!![b]!!.isstring()) {
                            name = p.k!![b]!!.strvalue()
                            return org.basaltmc.luak.lib.DebugLib.NameWhat(name!!.tojstring(), "constant")
                        }
                    }
                    ...
                    Lua.OP_SELF -> {
                        val k: Int = Lua.GETARG_C(i) /* key index */
                        val jname: String = org.basaltmc.luak.lib.DebugLib.Companion.kname(p, pc, k)
                        return org.basaltmc.luak.lib.DebugLib.NameWhat(jname, "method")
                    }
        ...
        fun kname(p: Prototype, pc: Int, c: Int): String {
            if (Lua.ISK(c)) {  /* is 'c' a constant? */
                ...
                val what: NameWhat? = org.basaltmc.luak.lib.DebugLib.Companion.getobjname(p, pc, c) /* search for 'c' */
...
internal fun callback(debuglib: DebugLib?, f: LuaValue, args: Varargs): Varargs {
    if (debuglib == null || f !is org.basaltmc.luak.LuaFunction || f is org.basaltmc.luak.LuaClosure) {
