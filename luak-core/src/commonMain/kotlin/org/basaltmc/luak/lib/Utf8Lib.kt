...
class Utf8Lib : TwoArgFunction() {
    ...
    override fun call(modname: LuaValue?, env: LuaValue?): LuaValue? {
        ...
        utf8.set("charpattern", org.basaltmc.luak.lib.Utf8Lib.CHAR_PATTERN)
        // Qualified: `len()` would otherwise resolve to LuaValue's own length
        // operator, which this class inherits.
        utf8.set("char", org.basaltmc.luak.lib.Utf8Lib.char())
        utf8.set("codepoint", org.basaltmc.luak.lib.Utf8Lib.codepoint())
        utf8.set("len", org.basaltmc.luak.lib.Utf8Lib.len())
        utf8.set("offset", org.basaltmc.luak.lib.Utf8Lib.offset())
        utf8.set("codes", org.basaltmc.luak.lib.Utf8Lib.codes())
        env.set("utf8", utf8)
