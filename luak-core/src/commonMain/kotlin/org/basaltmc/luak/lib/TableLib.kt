...
class TableLib : TwoArgFunction() {
    ...
    override fun call(modname: LuaValue?, env: LuaValue?): LuaValue? {
        ...
        table.set("concat", org.basaltmc.luak.lib.TableLib.concat())
        table.set("create", org.basaltmc.luak.lib.TableLib.create())
        table.set("insert", org.basaltmc.luak.lib.TableLib.insert())
        table.set("move", org.basaltmc.luak.lib.TableLib.move())
        table.set("pack", org.basaltmc.luak.lib.TableLib.pack())
        table.set("remove", org.basaltmc.luak.lib.TableLib.remove())
        table.set("sort", org.basaltmc.luak.lib.TableLib.sort(env as? org.basaltmc.luak.Globals))
        table.set("unpack", org.basaltmc.luak.lib.TableLib.unpack())
        env!!.set("table", table)
    ...
    // "sort" (table [, comp])
    internal class sort(private val globals: org.basaltmc.luak.Globals?) : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
