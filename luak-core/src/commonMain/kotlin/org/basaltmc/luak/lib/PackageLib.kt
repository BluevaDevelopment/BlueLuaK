...
import org.basaltmc.luak.platformLoadLibrary
...
class PackageLib : TwoArgFunction() {
    ...
    override fun call(modname: LuaValue?, env: LuaValue?): LuaValue? {
        ...
        package_ = LuaTable()
        package_!!.set(org.basaltmc.luak.lib.PackageLib.Companion._LOADED, LuaTable())
        package_!!.set(org.basaltmc.luak.lib.PackageLib.Companion._PRELOAD, LuaTable())
        package_!!.set(
            org.basaltmc.luak.lib.PackageLib.Companion._PATH,
            LuaValue.valueOf(org.basaltmc.luak.lib.PackageLib.Companion.DEFAULT_LUA_PATH)
        )
        package_!!.set(org.basaltmc.luak.lib.PackageLib.Companion._LOADLIB, org.basaltmc.luak.lib.PackageLib.loadlib())
        ...
        package_!!.set(org.basaltmc.luak.lib.PackageLib.Companion._SEARCHERS, searchers)
        // No C loader here, so the path for one is empty rather than absent:
        // a chunk that reads package.cpath still finds a string.
        package_!!.set("cpath", "")
        package_!!.set("config", org.basaltmc.luak.lib.PackageLib.Companion.FILE_SEP.toString() + "\n;\n?\n!\n-\n")
        package_!!.get((org.basaltmc.luak.lib.PackageLib.Companion._LOADED)!!).set("package", package_)
        ...
        package_!!.get((org.basaltmc.luak.lib.PackageLib.Companion._LOADED)!!).set("_G", env)
    ...
    fun setIsLoaded(name: String?, value: LuaTable?) {
        package_!!.get((org.basaltmc.luak.lib.PackageLib.Companion._LOADED)!!).set(name, value)
    }
    ...
    fun setLuaPath(newLuaPath: String?) {
        package_!!.set(org.basaltmc.luak.lib.PackageLib.Companion._PATH, LuaValue.valueOf(newLuaPath))
    }
    ...
    inner class require : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            val loaded: LuaValue = package_!!.get((org.basaltmc.luak.lib.PackageLib.Companion._LOADED)!!)
            var result: LuaValue = loaded.get((name)!!)
            if (result.toboolean()) {
                if (result === org.basaltmc.luak.lib.PackageLib.Companion._SENTINEL) error("loop or previous error loading module '" + name + "'")
            ...
            val searchers: LuaValue = package_!!.get((org.basaltmc.luak.lib.PackageLib.Companion._SEARCHERS)!!)
            ...
            loaded.set(name, org.basaltmc.luak.lib.PackageLib.Companion._SENTINEL)
            result = loader!!.arg1()!!.call(name, loader!!.arg(2))!!
            if (!result.isnil()) loaded.set(name, result)
            else if ((loaded.get((name)!!)
                    .also { result = it }) === org.basaltmc.luak.lib.PackageLib.Companion._SENTINEL
    ...
    inner class preload_searcher : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            val `val`: LuaValue = package_!!.get((org.basaltmc.luak.lib.PackageLib.Companion._PRELOAD)!!).get((name)!!)
    ...
    inner class lua_searcher : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            // get package path
            val path: LuaValue = package_!!.get((org.basaltmc.luak.lib.PackageLib.Companion._PATH)!!)
            ...
            var v: Varargs =
                package_!!.get((org.basaltmc.luak.lib.PackageLib.Companion._SEARCHPATH)!!).invoke((varargsOf(name, path))!!)
            ...
            } catch (le: org.basaltmc.luak.LuaError) {
    ...
    private fun badmodule(name: LuaString?, filename: LuaString, why: String?): Nothing {
        throw org.basaltmc.luak.LuaError(
    ...
    inner class searchpath : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            val rep: String = args.optjstring(4, org.basaltmc.luak.lib.PackageLib.Companion.FILE_SEP)!!
    ...
    inner class java_searcher : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            val found: Varargs = package_!!.get((org.basaltmc.luak.lib.PackageLib.Companion._SEARCHPATH)!!)
    ...
    companion object {
        ...
        fun toClassname(filename: String): String? {
            ...
            for (k in 0..<j) {
                ...
                if ((!org.basaltmc.luak.lib.PackageLib.Companion.isClassnamePart(c)) || (c == '/') || (c == '\\')) {
                    val sb: StringBuilder = StringBuilder(j)
                    for (i in 0..<j) {
                        c = filename[i]
                        sb.append(
                            if (org.basaltmc.luak.lib.PackageLib.Companion.isClassnamePart(c)) c else if ((c == '/') || (c == '\\')) '.' else '_'
                        )
                    }
                    return sb.toString()
                }
