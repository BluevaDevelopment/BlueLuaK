...
import org.basaltmc.luak.DateParts
import org.basaltmc.luak.currentTimeMillis
import org.basaltmc.luak.dateParts
import org.basaltmc.luak.epochSeconds
import org.basaltmc.luak.platformEnvironment
import org.basaltmc.luak.platformExit
...
import org.basaltmc.luak.io.platformRenameFile
 ...
 * [org.basaltmc.luak.lib.jvm.JvmOsLib].
 *
 *
 ...
 *
 * @see org.basaltmc.luak.lib.jvm.JvmOsLib
 *
 ...
 */
    ...
    override fun call(modname: LuaValue?, env: LuaValue?): LuaValue? {
        ...
        for (i in org.basaltmc.luak.lib.OsLib.Companion.NAMES.indices) os.set(
            org.basaltmc.luak.lib.OsLib.Companion.NAMES[i],
    ...
    internal inner class OsLibFunc(opcode: Int, name: String?) : VarArgFunction() {
        ...
        override fun invoke(args: Varargs): Varargs {
            try {
                when (opcode) {
                    org.basaltmc.luak.lib.OsLib.Companion.CLOCK -> return valueOf(clock())
                    org.basaltmc.luak.lib.OsLib.Companion.DATE -> {
                    ...
                    org.basaltmc.luak.lib.OsLib.Companion.DIFFTIME -> return valueOf(
                        difftime(
                            args.checkdouble(1),
                            args.checkdouble(2)
                        )
                    ...
                    org.basaltmc.luak.lib.OsLib.Companion.EXECUTE -> {
                    ...
                    org.basaltmc.luak.lib.OsLib.Companion.EXIT -> {
                        exit(args.optint(1, 0))
                        return (NONE)!!
                    }

                    org.basaltmc.luak.lib.OsLib.Companion.GETENV -> {
                        val `val`: String? = getenv(args.checkjstring(1))
                        return if (`val` != null) valueOf(`val`) else NIL
                    }

                    org.basaltmc.luak.lib.OsLib.Companion.REMOVE -> {
                        remove(args.checkjstring(1))
                        return (LuaValue.TRUE)!!
                    }

                    org.basaltmc.luak.lib.OsLib.Companion.RENAME -> {
                        rename(args.checkjstring(1), args.checkjstring(2))
                        return (LuaValue.TRUE)!!
                    }

                    org.basaltmc.luak.lib.OsLib.Companion.SETLOCALE -> {
                        val s = setlocale(args.optjstring(1, null), args.optjstring(2, "all"))
                        return if (s != null) valueOf(s) else NIL
                    }

                    org.basaltmc.luak.lib.OsLib.Companion.TIME -> return valueOf(time(args.opttable(1, null)))
                    org.basaltmc.luak.lib.OsLib.Companion.TMPNAME -> return valueOf(tmpname())
                }
                return (NONE)!!
            } catch (e: IOException) {
    ...
    protected fun clock(): Double {
        return (currentTimeMillis() - org.basaltmc.luak.lib.OsLib.Companion.t0) / 1000.0
    }
    ...
    companion object {
        ...
        private var tmpnames: Long = org.basaltmc.luak.lib.OsLib.Companion.t0
