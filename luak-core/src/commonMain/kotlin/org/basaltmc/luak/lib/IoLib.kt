...
import org.basaltmc.luak.io.EOFException
import org.basaltmc.luak.io.IOException
import org.basaltmc.luak.io.InputStream
import org.basaltmc.luak.io.PlatformFileHandle
import org.basaltmc.luak.io.PlatformFileMode
import org.basaltmc.luak.io.platformDeleteFile
import org.basaltmc.luak.io.platformOpenFile
import org.basaltmc.luak.io.platformStandardInput
import org.basaltmc.luak.io.platformTempFilePath
 ...
 * small set of host primitives in `org.basaltmc.luak.io`, so it behaves the same
 ...
 * by default and is overridden by [org.basaltmc.luak.lib.jvm.JvmIoLib].
 *
 *
 ...
 *
 * @see org.basaltmc.luak.lib.jvm.JvmIoLib
 *
...
open class IoLib : TwoArgFunction() {
     ...
     * the shared implementation always fails; [org.basaltmc.luak.lib.jvm.JvmIoLib]
    ...
    override fun call(modname: LuaValue?, env: LuaValue?): LuaValue? {
        ...
        bind(t, { IoLibV() }, org.basaltmc.luak.lib.IoLib.Companion.IO_NAMES)
        ...
        bind(
            (filemethods)!!,
            { IoLibV() },
            org.basaltmc.luak.lib.IoLib.Companion.FILE_NAMES,
            org.basaltmc.luak.lib.IoLib.Companion.FILE_CLOSE
        )
        ...
        bind(
            ...
            org.basaltmc.luak.lib.IoLib.Companion.IO_INDEX
        )
        t.setmetatable(mt)
        ...
        t.set("stdin", ioopenfile(org.basaltmc.luak.lib.IoLib.Companion.FTYPE_STDIN, "-", "r")!!)
        t.set("stdout", ioopenfile(org.basaltmc.luak.lib.IoLib.Companion.FTYPE_STDOUT, "-", "w")!!)
        t.set("stderr", ioopenfile(org.basaltmc.luak.lib.IoLib.Companion.FTYPE_STDERR, "-", "w")!!)
    ...
    internal class IoLibV : VarArgFunction {
        ...
        override fun invoke(args: Varargs): Varargs {
            try {
                when (opcode) {
                    org.basaltmc.luak.lib.IoLib.Companion.IO_FLUSH -> return iolib!!._io_flush()
                    org.basaltmc.luak.lib.IoLib.Companion.IO_TMPFILE -> return (iolib!!._io_tmpfile())!!
                    org.basaltmc.luak.lib.IoLib.Companion.IO_CLOSE -> return iolib!!._io_close((args.arg1())!!)
                    org.basaltmc.luak.lib.IoLib.Companion.IO_INPUT -> return (iolib!!._io_input((args.arg1())!!))!!
                    org.basaltmc.luak.lib.IoLib.Companion.IO_OUTPUT -> return (iolib!!._io_output((args.arg1())!!))!!
                    org.basaltmc.luak.lib.IoLib.Companion.IO_TYPE -> return (iolib!!._io_type(args.arg1()))!!
                    org.basaltmc.luak.lib.IoLib.Companion.IO_POPEN -> return iolib!!._io_popen(
                        args.checkjstring(1),
                        args.optjstring(2, "r")
                    )!!

                    org.basaltmc.luak.lib.IoLib.Companion.IO_OPEN -> return iolib!!._io_open(
                        args.checkjstring(1),
                        args.optjstring(2, "r")!!
                    )!!

                    org.basaltmc.luak.lib.IoLib.Companion.IO_LINES -> return (iolib!!._io_lines(args))!!
                    org.basaltmc.luak.lib.IoLib.Companion.IO_READ -> return iolib!!._io_read(args)
                    org.basaltmc.luak.lib.IoLib.Companion.IO_WRITE -> return iolib!!._io_write(args)

                    org.basaltmc.luak.lib.IoLib.Companion.FILE_CLOSE -> return iolib!!._file_close(args.arg1())
                    org.basaltmc.luak.lib.IoLib.Companion.FILE_FLUSH -> return iolib!!._file_flush(args.arg1())
                    org.basaltmc.luak.lib.IoLib.Companion.FILE_SETVBUF -> return iolib!!._file_setvbuf(
                        args.arg1(),
                        args.checkjstring(2),
                        args.optint(3, 8192)
                    )

                    org.basaltmc.luak.lib.IoLib.Companion.FILE_LINES -> return (iolib!!._file_lines(args))!!
                    org.basaltmc.luak.lib.IoLib.Companion.FILE_READ -> return iolib!!._file_read(
                        args.arg1(),
                        args.subargs(2)!!
                    )

                    org.basaltmc.luak.lib.IoLib.Companion.FILE_SEEK -> return iolib!!._file_seek(
                        args.arg1(),
                        args.optjstring(2, "cur"),
                        args.optint(3, 0)
                    )

                    org.basaltmc.luak.lib.IoLib.Companion.FILE_WRITE -> return iolib!!._file_write(
                        args.arg1(),
                        args.subargs(2)!!
                    )

                    org.basaltmc.luak.lib.IoLib.Companion.IO_INDEX -> return (iolib!!._io_index((args.arg(2))!!))!!
                    org.basaltmc.luak.lib.IoLib.Companion.LINES_ITER -> return iolib!!._lines_iter(f, toclose, (this.args)!!)
                }
            } catch (ioe: IOException) {
                if (opcode === org.basaltmc.luak.lib.IoLib.Companion.LINES_ITER) {
    ...
    private fun input(): File? {
        return if (infile != null) infile else (ioopenfile(
            org.basaltmc.luak.lib.IoLib.Companion.FTYPE_STDIN,
            "-",
            "r"
        ).also { infile = it })
    }
    ...
    fun _io_flush(): Varargs {
        org.basaltmc.luak.lib.IoLib.Companion.checkdefault(output(), "output")
        outfile!!.flush()
    ...
    fun _io_close(file: LuaValue): Varargs {
        val f = if (file.isnil()) output() else org.basaltmc.luak.lib.IoLib.Companion.checkfile(file)
        org.basaltmc.luak.lib.IoLib.Companion.checkopen(f)
        return org.basaltmc.luak.lib.IoLib.Companion.ioclose(f)
    }

    //	io.input([file]) -> file
    fun _io_input(file: LuaValue): Varargs? {
        infile = if (file.isnil()) input() else if (file.isstring()) ioopenfile(
            org.basaltmc.luak.lib.IoLib.Companion.FTYPE_NAMED,
            file.checkjstring(),
            "r"
        ) else org.basaltmc.luak.lib.IoLib.Companion.checkfile(file)
        return infile
    }
    ...
    fun _io_output(filename: LuaValue): Varargs? {
        outfile = if (filename.isnil()) output() else if (filename.isstring()) ioopenfile(
            ...
            "w"
        ) else org.basaltmc.luak.lib.IoLib.Companion.checkfile(filename)
        return outfile
    }

    //	io.type(obj) -> "file" | "closed file" | nil
    fun _io_type(obj: LuaValue?): Varargs? {
        val f: File? = org.basaltmc.luak.lib.IoLib.Companion.optfile(obj)
        return if (f != null) if (f.isclosed()) org.basaltmc.luak.lib.IoLib.Companion.CLOSED_FILE else org.basaltmc.luak.lib.IoLib.Companion.FILE else NIL
    }
    ...
    fun _io_open(filename: String?, mode: String): Varargs? {
        return rawopenfile(org.basaltmc.luak.lib.IoLib.Companion.FTYPE_NAMED, filename, mode)
    }
    ...
    fun _io_lines(args: Varargs): Varargs? {
        ...
        args.argcheck(
            args.narg() - 1 <= org.basaltmc.luak.lib.IoLib.Companion.MAX_LINE_FORMATS,
            org.basaltmc.luak.lib.IoLib.Companion.MAX_LINE_FORMATS + 2,
            "too many arguments",
        )
        ...
        org.basaltmc.luak.lib.IoLib.Companion.checkopen((infile)!!)
    ...
    fun _io_read(args: Varargs): Varargs {
        org.basaltmc.luak.lib.IoLib.Companion.checkdefault((input())!!, "input")
    ...
    fun _io_write(args: Varargs): Varargs {
        org.basaltmc.luak.lib.IoLib.Companion.checkdefault(output(), "output")
        return org.basaltmc.luak.lib.IoLib.Companion.iowrite((outfile)!!, args)
    }

    // file:close() -> void
    @kotlin.Throws(IOException::class)
    fun _file_close(file: LuaValue?): Varargs {
        return org.basaltmc.luak.lib.IoLib.Companion.ioclose(org.basaltmc.luak.lib.IoLib.Companion.checkfile(file))
    }
    ...
    internal class closehandle : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            val file: File? = org.basaltmc.luak.lib.IoLib.Companion.optfile(handle)
            ...
            return org.basaltmc.luak.lib.IoLib.Companion.ioclose(file)
        }
    }
    ...
    fun _file_flush(file: LuaValue?): Varargs {
        org.basaltmc.luak.lib.IoLib.Companion.checkfile(file).flush()
        return (LuaValue.TRUE)!!
    }
    ...
    fun _file_setvbuf(file: LuaValue?, mode: String?, size: Int): Varargs {
        ...
        org.basaltmc.luak.lib.IoLib.Companion.checkfile(file).setvbuf(mode, size)
        return (LuaValue.TRUE)!!
    }

    // file:lines(...) -> iterator
    fun _file_lines(args: Varargs): Varargs? {
        return lines(org.basaltmc.luak.lib.IoLib.Companion.checkfile(args.arg1()), false, (args.subargs(2))!!)
    }

    //	file:read(...) -> (...)
    @kotlin.Throws(IOException::class)
    fun _file_read(file: LuaValue?, subargs: Varargs): Varargs {
        return ioread(org.basaltmc.luak.lib.IoLib.Companion.checkfile(file), subargs)
    }
    ...
    fun _file_seek(file: LuaValue?, whence: String?, offset: Int): Varargs {
        ...
        return valueOf(org.basaltmc.luak.lib.IoLib.Companion.checkfile(file).seek(whence, offset))
    }

    //	file:write(...) -> void
    @kotlin.Throws(IOException::class)
    fun _file_write(file: LuaValue?, subargs: Varargs): Varargs {
        return org.basaltmc.luak.lib.IoLib.Companion.iowrite(org.basaltmc.luak.lib.IoLib.Companion.checkfile(file), subargs)
    }

    // __index, returns a field
    fun _io_index(v: LuaValue): Varargs? {
        return if (v.equals(org.basaltmc.luak.lib.IoLib.Companion.STDOUT)) output() else if (v.equals(org.basaltmc.luak.lib.IoLib.Companion.STDIN)) input() else if (v.equals(
                org.basaltmc.luak.lib.IoLib.Companion.STDERR
            )
        ) errput() else NIL
    }
    ...
    fun _lines_iter(file: LuaValue?, toclose: Boolean, args: Varargs): Varargs {
        val f: File? = org.basaltmc.luak.lib.IoLib.Companion.optfile(file)
    ...
    private fun output(): File {
        return (if (outfile != null) outfile else (ioopenfile(
            org.basaltmc.luak.lib.IoLib.Companion.FTYPE_STDOUT,
            "-",
            "w"
        ).also { outfile = it }))!!
    }
    ...
    private fun errput(): File? {
        return if (errfile != null) errfile else (ioopenfile(
            org.basaltmc.luak.lib.IoLib.Companion.FTYPE_STDERR,
            "-",
            "w"
        ).also { errfile = it })
    }
    ...
    private fun lines(f: File?, toclose: Boolean, args: Varargs): Varargs? {
        val iterator: LuaValue = try {
            org.basaltmc.luak.lib.IoLib.IoLibV(
                f,
                "lnext",
                org.basaltmc.luak.lib.IoLib.Companion.LINES_ITER,
                this,
                toclose,
                args
            )
    ...
    private fun ioread(f: File, args: Varargs): Varargs {
        var i: Int
        val n: Int = args.narg()
        if (n == 0) return org.basaltmc.luak.lib.IoLib.Companion.freadline(f, false)
        ...
        while (i < n) {
            run item@ {
                ...
                LuaValue.TNUMBER -> {
                    vi = org.basaltmc.luak.lib.IoLib.Companion.freadbytes(f, ai!!.toint())
                    return@item
                }
                ...
                LuaValue.TSTRING -> {
                    ...
                    if (fmt.m_length >= star + 1) {
                        when (fmt.m_bytes[fmt.m_offset + star]) {
                            'n'.code.toByte() -> {
                                vi = org.basaltmc.luak.lib.IoLib.Companion.freadnumber(f)
                                return@item
                            }

                            'l'.code.toByte() -> {
                                vi = org.basaltmc.luak.lib.IoLib.Companion.freadline(f, false)
                                return@item
                            }

                            'L'.code.toByte() -> {
                                vi = org.basaltmc.luak.lib.IoLib.Companion.freadline(f, true)
                                return@item
                            }

                            'a'.code.toByte() -> {
                                vi = org.basaltmc.luak.lib.IoLib.Companion.freadall(f)
                                return@item
                            }
                        }
                    }
    ...
    private fun rawopenfile(filetype: Int, filename: String?, mode: String): File? {
        ...
        when (filetype) {
            org.basaltmc.luak.lib.IoLib.Companion.FTYPE_STDIN -> return wrapStdin()
            org.basaltmc.luak.lib.IoLib.Companion.FTYPE_STDOUT -> return wrapStdout()
            org.basaltmc.luak.lib.IoLib.Companion.FTYPE_STDERR -> return wrapStderr()
        }
    ...
    companion object {
        ...
        internal fun ioclose(f: File): Varargs {
            if (f.isstdfile()) return org.basaltmc.luak.lib.IoLib.Companion.errorresult("cannot close standard file")
            else {
                f.close()
                return org.basaltmc.luak.lib.IoLib.Companion.successresult()
            }
        }
        ...
        fun errorresult(ioe: Exception): Varargs {
            ...
            return org.basaltmc.luak.lib.IoLib.Companion.errorresult(
        ...
        private fun checkfile(`val`: LuaValue?): File {
            val f: File? = org.basaltmc.luak.lib.IoLib.Companion.optfile(`val`)
        ...
        fun freadline(f: File, withend: Boolean): LuaValue {
            return org.basaltmc.luak.lib.IoLib.Companion.freaduntil(f, true, withend)
        }
        ...
        fun freadall(f: File): LuaValue? {
            val n = f.remaining()
            if (n >= 0) {
                return if (n == 0) EMPTYSTRING else org.basaltmc.luak.lib.IoLib.Companion.freadbytes(f, n)
            } else {
                return org.basaltmc.luak.lib.IoLib.Companion.freaduntil(f, false, false)
            }
        }
        ...
        fun freadnumber(f: File): LuaValue {
            ...
            fun one(chars: String): Boolean {
                ...
                if (length >= org.basaltmc.luak.lib.IoLib.Companion.MAX_NUMERAL_LENGTH) {
                    overflowed = true
                    return false
                }
                f.read()
            ...
            org.basaltmc.luak.lib.IoLib.Companion.freadchars(f, " \t\r\n", null)
            one("-+")
            ...
            return org.basaltmc.luak.NumberParser.parse(s) ?: NIL
        }
