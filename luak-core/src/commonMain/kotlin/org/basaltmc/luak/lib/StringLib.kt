...
import org.basaltmc.luak.Buffer
import org.basaltmc.luak.LuaClosure
import org.basaltmc.luak.LuaString
import org.basaltmc.luak.LuaTable
import org.basaltmc.luak.LuaValue
import org.basaltmc.luak.Varargs
import org.basaltmc.luak.compiler.DumpState
import org.basaltmc.luak.io.ByteArrayOutputStream
 ...
 * [org.basaltmc.luak.lib.LuaPlatform.standardGlobals]
 * ```kotlin
 ...
 * [.call].  */
    ...
    override fun call(modname: LuaValue?, env: LuaValue?): LuaValue? {
        ...
        string.set("byte", org.basaltmc.luak.lib.StringLib._byte())
        string.set("char", org.basaltmc.luak.lib.StringLib._char())
        string.set("dump", org.basaltmc.luak.lib.StringLib.dump())
        string.set("find", org.basaltmc.luak.lib.StringLib.find())
        string.set("format", format())
        string.set("gmatch", org.basaltmc.luak.lib.StringLib.gmatch())
        string.set("gsub", org.basaltmc.luak.lib.StringLib.gsub(env as? org.basaltmc.luak.Globals))
        string.set("len", org.basaltmc.luak.lib.StringLib.len())
        string.set("lower", org.basaltmc.luak.lib.StringLib.lower())
        string.set("match", org.basaltmc.luak.lib.StringLib.match())
        string.set("pack", org.basaltmc.luak.lib.StringLib.pack())
        string.set("packsize", org.basaltmc.luak.lib.StringLib.packsize())
        string.set("rep", org.basaltmc.luak.lib.StringLib.rep())
        string.set("unpack", org.basaltmc.luak.lib.StringLib.unpack())
        string.set("reverse", org.basaltmc.luak.lib.StringLib.reverse())
        string.set("sub", org.basaltmc.luak.lib.StringLib.sub())
        string.set("upper", org.basaltmc.luak.lib.StringLib.upper())
    ...
    internal class pack : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs = org.basaltmc.luak.lib.StringPack.pack(args)
    }

    /** `string.packsize (fmt)`, from Lua 5.3. */
    internal class packsize : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs = org.basaltmc.luak.lib.StringPack.packsize(args)
    }

    /** `string.unpack (fmt, s [, pos])`, from Lua 5.3. */
    internal class unpack : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs = org.basaltmc.luak.lib.StringPack.unpack(args)
    }
    ...
    internal class _byte : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            var posi: Int = org.basaltmc.luak.lib.StringLib.Companion.posrelat(args.optint(2, 1), l)
            var pose: Int = org.basaltmc.luak.lib.StringLib.Companion.posrelat(args.optint(3, posi), l)
            val n: Int
            var i: Int
            if (posi <= 0) posi = 1
            if (pose > l) pose = l
    ...
    internal class find : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            return org.basaltmc.luak.lib.StringLib.Companion.str_find_aux(args, true)
        }
    }
        ...
        override fun invoke(args: Varargs): Varargs {
            ...
            while (i < n) {
                when (fmt.luaByte(i++).also { c = it }) {
                    '\n'.code -> result.append("\n")
                    org.basaltmc.luak.lib.StringLib.Companion.L_ESC -> if (i < n) {
                        if ((fmt.luaByte(i).also { c = it }) == org.basaltmc.luak.lib.StringLib.Companion.L_ESC) {
                            ++i
                            result.append(org.basaltmc.luak.lib.StringLib.Companion.L_ESC.toByte())
                        } else {
                            ...
                            when (fdsc.conversion) {
                                ...
                                'p'.code -> {
                                    val text: LuaString =
                                        org.basaltmc.luak.lib.StringLib.Companion.pointer(args.arg(arg)!!)
                                    fdsc.check(FLAGS_C, precision = false)
                                ...
                                'q'.code -> {
                                    ...
                                    org.basaltmc.luak.lib.StringLib.Companion.addliteral(
                                        result,
                                        args.arg(arg)!!,
                                    )
                                }
                                ...
                                's'.code -> {
                                    ...
                                    val s: LuaString = org.basaltmc.luak.lib.BaseLib
    ...
    internal inner class FormatDesc(strfrmt: LuaString, start: Int) {
        ...
        init {
            ...
            var p = start
            while (p < n && org.basaltmc.luak.lib.StringLib.Companion.isSpecSpan(strfrmt.luaByte(p))) p++
        ...
        fun format(buf: Buffer, x: Double) {
            ...
            var text: String = when (conversion.toChar()) {
                'e' -> org.basaltmc.luak.DecimalFormat.e(x, digits, upper = false)
                'E' -> org.basaltmc.luak.DecimalFormat.e(x, digits, upper = true)
                'f', 'F' -> {
                    val rendered: String = org.basaltmc.luak.DecimalFormat.f(x, digits)
                ...
                'G' -> org.basaltmc.luak.DecimalFormat.g(x, digits).uppercase()
                else -> org.basaltmc.luak.DecimalFormat.g(x, digits)
            }
            if (!text.startsWith("-")) {
        ...
        fun formathex(buf: Buffer, value: Double, upper: Boolean) {
            var text: String = org.basaltmc.luak.DecimalFormat.hex(value, upper, precision)
            if (!text.startsWith("-")) {
                if (explicitPlus) text = "+" + text else if (space) text = " " + text
            }
            val padding: Int = width - text.length
    ...
    internal class gmatch : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            val init: Int = org.basaltmc.luak.lib.StringLib.Companion.posrelat(
                args.optint(3, 1),
                src.length(),
            )
            val start: Int = when {
            ...
            return org.basaltmc.luak.lib.StringLib.GMatchAux(args, src, pat, start)
        }
    }
    ...
    internal class GMatchAux(args: Varargs, src: LuaString, pat: LuaString, start: Int = 0) :
        ...
        init {
            ...
            this.ms = org.basaltmc.luak.lib.StringLib.MatchState(args, src, pat)
            this.soffset = start
            this.lastmatch = -1
        }
     ...
     * --> x="lua-5.1.tar.gz"
     */
    internal class gsub(private val globals: org.basaltmc.luak.Globals?) : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            val src: LuaString = args.checkstring(1)
            ...
            val ms: MatchState = org.basaltmc.luak.lib.StringLib.MatchState(args, src, p)
    ...
    internal class match : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            return org.basaltmc.luak.lib.StringLib.Companion.str_find_aux(args, false)
        }
    }
    ...
    internal class sub : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            ...
            var start: Int = org.basaltmc.luak.lib.StringLib.Companion.posrelat(args.checkint(2), l)
            var end: Int = org.basaltmc.luak.lib.StringLib.Companion.posrelat(args.optint(3, -1), l)
    ...
    internal class MatchState(args: Varargs, s: LuaString, pattern: LuaString) {
        ...
        init {
            ...
            this.args = args
            this.level = 0
            this.cinit = IntArray(org.basaltmc.luak.lib.StringLib.Companion.MAX_CAPTURES)
            this.clen = IntArray(org.basaltmc.luak.lib.StringLib.Companion.MAX_CAPTURES)
            this.matchdepth = org.basaltmc.luak.lib.StringLib.Companion.MAXCCALLS
        }
        ...
        private fun add_s(lbuf: Buffer, news: LuaString, soff: Int, e: Int) {
            ...
            while (i < l) {
                ...
                if (b.toInt() != org.basaltmc.luak.lib.StringLib.Companion.L_ESC) {
                    lbuf.append(b)
                } else {
                    ++i // skip ESC
                    b = (if (i < l) news.luaByte(i) else 0).toByte()
                    if (!Char(b.toUShort()).isDigit()) {
                        if (b.toInt() != org.basaltmc.luak.lib.StringLib.Companion.L_ESC) error(
                            "invalid use of '" + org.basaltmc.luak.lib.StringLib.Companion.L_ESC.toChar() +
                                    "' in replacement string: after '" + org.basaltmc.luak.lib.StringLib.Companion.L_ESC.toChar() +
                                    "' must be '0'-'9' or '" + org.basaltmc.luak.lib.StringLib.Companion.L_ESC.toChar() +
        ...
        private fun push_onecapture(i: Int, soff: Int, end: Int): LuaValue {
            if (i >= this.level) {
                ...
                val l = clen!![i]
                if (l == org.basaltmc.luak.lib.StringLib.Companion.CAP_UNFINISHED) {
                    return (error("unfinished capture"))!!
                }
                if (l == org.basaltmc.luak.lib.StringLib.Companion.CAP_POSITION) {
        ...
        private fun check_capture(l: Int): Int {
            var l = l
            l -= '1'.code
            if (l < 0 || l >= level || this.clen!![l] == org.basaltmc.luak.lib.StringLib.Companion.CAP_UNFINISHED) {
        ...
        private fun capture_to_close(): Int {
            ...
            level--
            while (level >= 0) {
                if (clen!![level] == org.basaltmc.luak.lib.StringLib.Companion.CAP_UNFINISHED) return level
                level--
            }
        ...
        fun classend(poffset: Int): Int {
            ...
            when (p.luaByte(poffset++)) {
                org.basaltmc.luak.lib.StringLib.Companion.L_ESC -> {
                    if (poffset == p.length()) {
                ...
                '['.code -> {
                    ...
                    do {
                        ...
                        if (p.luaByte(poffset++) === org.basaltmc.luak.lib.StringLib.Companion.L_ESC && poffset < p.length()) poffset++ /* skip escapes (e.g. '%]') */
        ...
        fun matchbracketclass(c: Int, poff: Int, ec: Int): Boolean {
            ...
            while (++poff < ec) {
                if (p.luaByte(poff) === org.basaltmc.luak.lib.StringLib.Companion.L_ESC) {
                    poff++
                    if (org.basaltmc.luak.lib.StringLib.MatchState.Companion.match_class(c, p.luaByte(poff))) return sig
        ...
        fun singlematch(c: Int, poff: Int, ep: Int): Boolean {
            when (p.luaByte(poff)) {
                '.'.code -> return true
                org.basaltmc.luak.lib.StringLib.Companion.L_ESC -> return org.basaltmc.luak.lib.StringLib.MatchState.Companion.match_class(
                    c,
                    p.luaByte(poff + 1)
                )
                ...
                while (true) {
                    ...
                    when (p.luaByte(poffset)) {
                        '('.code -> if (++poffset < p.length() && p.luaByte(poffset) == ')'.code) return start_capture(
                            soffset,
                            poffset + 1,
                            org.basaltmc.luak.lib.StringLib.Companion.CAP_POSITION
                        )
                        else return start_capture(
                            soffset,
                            poffset,
                            org.basaltmc.luak.lib.StringLib.Companion.CAP_UNFINISHED
                        )
        ...
        fun start_capture(soff: Int, poff: Int, what: Int): Int {
            ...
            if (level >= org.basaltmc.luak.lib.StringLib.Companion.MAX_CAPTURES) {
        ...
        companion object {
            fun match_class(c: Int, cl: Int): Boolean {
                ...
                val cdata: Int = org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[c].toInt()

                val res: Boolean
                when (lcl) {
                    'a' -> res = (cdata and org.basaltmc.luak.lib.StringLib.Companion.MASK_ALPHA.toInt()) != 0
                    'd' -> res = (cdata and org.basaltmc.luak.lib.StringLib.Companion.MASK_DIGIT.toInt()) != 0
                    'l' -> res = (cdata and org.basaltmc.luak.lib.StringLib.Companion.MASK_LOWERCASE.toInt()) != 0
                    'u' -> res = (cdata and org.basaltmc.luak.lib.StringLib.Companion.MASK_UPPERCASE.toInt()) != 0
                    'c' -> res = (cdata and org.basaltmc.luak.lib.StringLib.Companion.MASK_CONTROL.toInt()) != 0
                    'p' -> res = (cdata and org.basaltmc.luak.lib.StringLib.Companion.MASK_PUNCT.toInt()) != 0
                    's' -> res = (cdata and org.basaltmc.luak.lib.StringLib.Companion.MASK_SPACE.toInt()) != 0
                    'g' -> res =
                        (cdata and (org.basaltmc.luak.lib.StringLib.Companion.MASK_ALPHA.toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_DIGIT.toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_PUNCT.toInt())) != 0

                    'w' -> res =
                        (cdata and (org.basaltmc.luak.lib.StringLib.Companion.MASK_ALPHA.toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_DIGIT.toInt())) != 0

                    'x' -> res = (cdata and org.basaltmc.luak.lib.StringLib.Companion.MASK_HEXDIGIT.toInt()) != 0
                    'z' -> res = (c == 0)
                    else -> return cl == c
                }
    ...
    companion object {
        ...
        fun addliteral(buf: Buffer, value: LuaValue) {
            when (value.type()) {
                LuaValue.TSTRING -> {
                    org.basaltmc.luak.lib.StringLib.Companion.addquoted(buf, value.checkstring()!!)
                    return
                }
                    ...
                    if (value.isinttype()) {
                        ...
                        buf.append(
                            when {
                                ...
                                else -> org.basaltmc.luak.DecimalFormat.hex(d, upper = false)
                            },
                        )
                    }
                    return
        ...
        fun str_find_aux(args: Varargs, find: Boolean): Varargs {
            ...
            val fastMatch = find && (args.arg(4)
                !!.toboolean() || pat.indexOfAny((org.basaltmc.luak.lib.StringLib.Companion.SPECIALS)!!) === -1)
            ...
            if (fastMatch) {
                ...
                val ms: MatchState = org.basaltmc.luak.lib.StringLib.MatchState(args, s, pat)
        ...
        init {
            ...
            for (i in 0..127) {
                val c = i.toChar()
                org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[i] =
                    ((if (c.isDigit()) org.basaltmc.luak.lib.StringLib.Companion.MASK_DIGIT else 0).toInt() or
                            (if (c.isLowerCase()) org.basaltmc.luak.lib.StringLib.Companion.MASK_LOWERCASE else 0).toInt() or
                            (if (c.isUpperCase()) org.basaltmc.luak.lib.StringLib.Companion.MASK_UPPERCASE else 0).toInt() or
                            (if (c < ' ' || c.code == 0x7F) org.basaltmc.luak.lib.StringLib.Companion.MASK_CONTROL else 0).toInt()).toByte()
                if ((c >= 'a' && c <= 'f') || (c >= 'A' && c <= 'F') || (c >= '0' && c <= '9')) {
                    org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[i] =
                        (org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[i].toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_HEXDIGIT.toInt()).toByte()
                }
                if ((c >= '!' && c <= '/') || (c >= ':' && c <= '@') || (c >= '[' && c <= '`') || (c >= '{' && c <= '~')) {
                    org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[i] =
                        (org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[i].toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_PUNCT.toInt()).toByte()
                }
                if ((org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[i].toInt() and (org.basaltmc.luak.lib.StringLib.Companion.MASK_LOWERCASE.toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_UPPERCASE.toInt())) != 0) {
                    org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[i] =
                        (org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[i].toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_ALPHA.toInt()).toByte()
                }
            }

            org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[' '.code] =
                org.basaltmc.luak.lib.StringLib.Companion.MASK_SPACE
            org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE['\r'.code] =
                (org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE['\r'.code].toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_SPACE.toInt()).toByte()
            org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE['\n'.code] =
                (org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE['\n'.code].toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_SPACE.toInt()).toByte()
            org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE['\t'.code] =
                (org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE['\t'.code].toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_SPACE.toInt()).toByte()
            org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[0x0B /* '\v' */] =
                (org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE[0x0B].toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_SPACE.toInt()).toByte()
            org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE['\u000C'.code] =
                (org.basaltmc.luak.lib.StringLib.Companion.CHAR_TABLE['\u000C'.code].toInt() or org.basaltmc.luak.lib.StringLib.Companion.MASK_SPACE.toInt()).toByte()
        }
    }
