...
class Bit32Lib : TwoArgFunction() {
    ...
    internal class Bit32LibV : VarArgFunction() {
        override fun invoke(args: Varargs): Varargs {
            val a = args!!
            when (opcode) {
                0 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.band(a)
                1 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.bnot(a)
                2 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.bor(a)
                3 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.btest(a)
                4 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.bxor(a)
                5 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.extract(
                    a.checkint(1),
                    a.checkint(2),
                    a.optint(3, 1)
                )

                6 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.replace(
    ...
    internal class Bit32Lib2 : TwoArgFunction() {
        override fun call(arg1: LuaValue?, arg2: LuaValue?): LuaValue? {
            when (opcode) {
                0 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.arshift(arg1!!.checkint(), arg2!!.checkint())
                1 -> return (org.basaltmc.luak.lib.Bit32Lib.Companion.lrotate(arg1!!.checkint(), arg2!!.checkint()))!!
                2 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.lshift(arg1!!.checkint(), arg2!!.checkint())
                3 -> return (org.basaltmc.luak.lib.Bit32Lib.Companion.rrotate(arg1!!.checkint(), arg2!!.checkint()))!!
                4 -> return org.basaltmc.luak.lib.Bit32Lib.Companion.rshift(arg1!!.checkint(), arg2!!.checkint())
            }
            return NIL
        }
    }
    ...
    companion object {
        fun arshift(x: Int, disp: Int): LuaValue {
            if (disp >= 0) {
                return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue(x shr disp)
            } else {
                return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue(x shl -disp)
            }
        }
        ...
        fun rshift(x: Int, disp: Int): LuaValue {
            if (disp >= 32 || disp <= -32) {
                ...
                return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue(x ushr disp)
            } else {
                return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue(x shl -disp)
            }
        }
        ...
        fun band(args: Varargs): Varargs {
            ...
            return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue(result)
        }

        fun bnot(args: Varargs): Varargs {
            return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue(args.checkint(1).inv())
        }
        ...
        fun lrotate(x: Int, disp: Int): LuaValue? {
            var disp = disp
            if (disp < 0) {
                return org.basaltmc.luak.lib.Bit32Lib.Companion.rrotate(x, -disp)
            } else {
                disp = disp and 31
                return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue((x shl disp) or (x ushr (32 - disp)))
            }
        }
        ...
        fun rrotate(x: Int, disp: Int): LuaValue? {
            var disp = disp
            if (disp < 0) {
                return org.basaltmc.luak.lib.Bit32Lib.Companion.lrotate(x, -disp)
            } else {
                disp = disp and 31
                return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue((x ushr disp) or (x shl (32 - disp)))
            }
        }
        ...
        fun extract(n: Int, field: Int, width: Int): LuaValue {
            ...
            return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue((n ushr field) and (-1 ushr (32 - width)))
        }
        ...
        fun replace(n: Int, v: Int, field: Int, width: Int): LuaValue {
            ...
            return org.basaltmc.luak.lib.Bit32Lib.Companion.bitsToValue(n)
        }
