...
class CoroutineLib : TwoArgFunction() {
    ...
    override fun call(modname: LuaValue?, env: LuaValue?): LuaValue? {
        ...
        coroutine.set("resume", org.basaltmc.luak.lib.CoroutineLib.resume())
        coroutine.set("running", running())
        coroutine.set("status", org.basaltmc.luak.lib.CoroutineLib.status())
    ...
    internal inner class wrap : LibFunction() {
        override fun call(f: LuaValue?): LuaValue? {
            ...
            return org.basaltmc.luak.lib.CoroutineLib.wrapper(thread)
        }
    }
