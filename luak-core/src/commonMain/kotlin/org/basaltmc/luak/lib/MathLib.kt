...
import org.basaltmc.luak.LuaDouble
 ...
 * [org.basaltmc.luak.lib.LuaPlatform.standardGlobals] (any target) or
 * [org.basaltmc.luak.lib.jvm.JvmPlatform.standardGlobals] (JVM only):
 * ```kotlin
...
open class MathLib : TwoArgFunction() {
     ...
     * [.call].  */
    init {
        org.basaltmc.luak.lib.MathLib.Companion.MATHLIB = this
    }
     ...
     *
     * Reached through [org.basaltmc.luak.Globals.seedrandom]; see it for why a
     * host wants to.
     */
    ...
    open override fun call(modname: LuaValue?, env: LuaValue?): LuaValue? {
        ...
        math.set("abs", org.basaltmc.luak.lib.MathLib.abs())
        math.set("acos", org.basaltmc.luak.lib.MathLib.acos())
        math.set("asin", org.basaltmc.luak.lib.MathLib.asin())
        val atan: LuaValue = org.basaltmc.luak.lib.MathLib.atan()
        math.set("atan", atan)
        math.set("ceil", org.basaltmc.luak.lib.MathLib.ceil())
        math.set("cos", org.basaltmc.luak.lib.MathLib.cos())
        math.set("deg", org.basaltmc.luak.lib.MathLib.deg())
        math.set("exp", org.basaltmc.luak.lib.MathLib.exp())
        math.set("floor", org.basaltmc.luak.lib.MathLib.floor())
        math.set("fmod", org.basaltmc.luak.lib.MathLib.fmod())
        math.set("frexp", org.basaltmc.luak.lib.MathLib.frexp())
        ...
        math.set("ldexp", org.basaltmc.luak.lib.MathLib.ldexp())
        math.set("log", org.basaltmc.luak.lib.MathLib.log())
        math.set("max", org.basaltmc.luak.lib.MathLib.max())
        math.set("min", org.basaltmc.luak.lib.MathLib.min())
        math.set("modf", org.basaltmc.luak.lib.MathLib.modf())
        math.set("pi", kotlin.math.PI)
        val r: random?
        math.set("random", org.basaltmc.luak.lib.MathLib.random().also { r = it })
        math.set("randomseed", org.basaltmc.luak.lib.MathLib.randomseed((r)!!))
        randomfunction = r
        math.set("rad", org.basaltmc.luak.lib.MathLib.rad())
        math.set("sin", org.basaltmc.luak.lib.MathLib.sin())
        math.set("sqrt", org.basaltmc.luak.lib.MathLib.sqrt())
        math.set("tan", org.basaltmc.luak.lib.MathLib.tan())
        math.set("tointeger", org.basaltmc.luak.lib.MathLib.tointeger())
        math.set("type", org.basaltmc.luak.lib.MathLib.type())
        math.set("ult", org.basaltmc.luak.lib.MathLib.ult())
        ...
        env!!.set("math", math)
        (env as? org.basaltmc.luak.Globals)?.mathlib = this
    ...
    internal class ceil : OneArgFunction() {
        override fun call(arg: LuaValue?): LuaValue? {
            val x: LuaValue = arg!!
            if (x.isinttype()) return x
            return org.basaltmc.luak.lib.MathLib.Companion.narrowToInteger(kotlin.math.ceil(x.checkdouble()))
        }
    }
    ...
    internal class floor : OneArgFunction() {
        override fun call(arg: LuaValue?): LuaValue? {
            val x: LuaValue = arg!!
            if (x.isinttype()) return x
            return org.basaltmc.luak.lib.MathLib.Companion.narrowToInteger(kotlin.math.floor(x.checkdouble()))
        }
    }
    ...
    internal class ldexp : BinaryOp() {
        override fun call(x: Double, y: Double): Double {
            ...
            while (remaining > 1000) {
                result *= org.basaltmc.luak.lib.MathLib.Companion.TWO_POW_1000
                remaining -= 1000
            }
            while (remaining < -1000) {
                result /= org.basaltmc.luak.lib.MathLib.Companion.TWO_POW_1000
    ...
    internal class pow : BinaryOp() {
        override fun call(x: Double, y: Double): Double {
            return org.basaltmc.luak.lib.MathLib.Companion.dpow_default(x, y)
        }
    }
    ...
    open fun dpow_lib(a: Double, b: Double): Double {
        return org.basaltmc.luak.lib.MathLib.Companion.dpow_default(a, b)
    }
    ...
    companion object {
        ...
        fun dpow(a: Double, b: Double): LuaValue {
            return LuaDouble.valueOf(org.basaltmc.luak.lib.MathLib.Companion.dpow_d(a, b))!!
        }

        fun dpow_d(a: Double, b: Double): Double {
            val installed: MathLib? = org.basaltmc.luak.lib.MathLib.Companion.MATHLIB
            return installed?.dpow_lib(a, b) ?: org.basaltmc.luak.lib.MathLib.Companion.dpow_default(a, b)
        }
