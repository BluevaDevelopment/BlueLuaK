...
/** Don't allow ints to be boxed by DoubleValues   */ private constructor(
    ...
    override fun neg(): LuaValue {
        return (org.basaltmc.luak.LuaDouble.Companion.valueOf(-v))!!
    }
    ...
    override fun add(lhs: Double): LuaValue {
        return (org.basaltmc.luak.LuaDouble.Companion.valueOf(lhs + v))!!
    }

    override fun add(rhs: Long): LuaValue {
        return (org.basaltmc.luak.LuaDouble.Companion.valueOf(rhs + v))!!
    }
    ...
    override fun sub(rhs: Double): LuaValue? {
        return org.basaltmc.luak.LuaDouble.Companion.valueOf(v - rhs)
    }
    ...
    override fun band(rhs: LuaValue): LuaValue = bitwise(org.basaltmc.luak.LuaValue.Companion.BAND, rhs)
    override fun bor(rhs: LuaValue): LuaValue = bitwise(org.basaltmc.luak.LuaValue.Companion.BOR, rhs)
    override fun bxor(rhs: LuaValue): LuaValue = bitwise(org.basaltmc.luak.LuaValue.Companion.BXOR, rhs)
    override fun shl(rhs: LuaValue): LuaValue = bitwise(org.basaltmc.luak.LuaValue.Companion.SHL, rhs)
    override fun shr(rhs: LuaValue): LuaValue = bitwise(org.basaltmc.luak.LuaValue.Companion.SHR, rhs)
    ...
    private fun bitwise(tag: LuaString, rhs: LuaValue): LuaValue {
        ...
        return when (tag) {
            org.basaltmc.luak.LuaValue.Companion.BAND -> LuaValue.valueOf(x and y)
            org.basaltmc.luak.LuaValue.Companion.BOR -> LuaValue.valueOf(x or y)
            org.basaltmc.luak.LuaValue.Companion.BXOR -> LuaValue.valueOf(x xor y)
            org.basaltmc.luak.LuaValue.Companion.SHL -> LuaValue.valueOf(luaShiftLeft(x, y))
    ...
    override fun idiv(rhs: LuaValue): LuaValue {
        ...
        if (other.isnil()) return arithmt(org.basaltmc.luak.LuaValue.Companion.IDIV, rhs)
    ...
    override fun div(rhs: Double): LuaValue? {
        return org.basaltmc.luak.LuaDouble.Companion.ddiv(v, rhs)
    }

    override fun div(rhs: Long): LuaValue? {
        return org.basaltmc.luak.LuaDouble.Companion.ddiv(v, rhs.toDouble())
    }

    override fun divInto(lhs: Double): LuaValue {
        return (org.basaltmc.luak.LuaDouble.Companion.ddiv(lhs, v))!!
    }
    ...
    override fun mod(rhs: Double): LuaValue? {
        return org.basaltmc.luak.LuaDouble.Companion.dmod(v, rhs)
    }

    override fun mod(rhs: Long): LuaValue? {
        return org.basaltmc.luak.LuaDouble.Companion.dmod(v, rhs.toDouble())
    }

    override fun modFrom(lhs: Double): LuaValue {
        return (org.basaltmc.luak.LuaDouble.Companion.dmod(lhs, v))!!
    }
    ...
    companion object {
        ...
        val NAN: LuaDouble = org.basaltmc.luak.LuaDouble(Double.NaN)

        /** Constant LuaDouble representing positive infinity  */
        val POSINF: LuaDouble = org.basaltmc.luak.LuaDouble(Double.POSITIVE_INFINITY)

        /** Constant LuaDouble representing negative infinity  */
        val NEGINF: LuaDouble = org.basaltmc.luak.LuaDouble(Double.NEGATIVE_INFINITY)
        ...
        fun valueOf(d: Double): LuaNumber? {
            return org.basaltmc.luak.LuaDouble(d)
        }
        ...
        fun ddiv(lhs: Double, rhs: Double): LuaValue? {
            ...
            return org.basaltmc.luak.LuaDouble.Companion.valueOf(lhs / rhs)
        }
        ...
        fun dmod(lhs: Double, rhs: Double): LuaValue? {
            return org.basaltmc.luak.LuaDouble.Companion.valueOf(luaFloatMod(lhs, rhs))
        }
