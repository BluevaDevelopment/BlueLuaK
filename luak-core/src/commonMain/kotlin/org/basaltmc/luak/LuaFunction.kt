 ...
 * 
 * 
 * Direct subclass include [org.basaltmc.luak.lib.LibFunction]
 ...
 * @see LuaClosure
 * 
 * @see org.basaltmc.luak.lib.LibFunction
 */
abstract
class LuaFunction : LuaValue() {
    ...
    override fun getmetatable(): LuaValue? {
        return org.basaltmc.luak.LuaFunction.Companion.s_metatable
    }
