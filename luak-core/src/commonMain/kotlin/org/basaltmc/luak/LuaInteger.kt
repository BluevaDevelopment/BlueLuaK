 ...
 */ internal constructor(
    ...
    override fun hashCode(): Int {
        return org.basaltmc.luak.LuaInteger.Companion.hashCode(v)
    }

    // unary operators
    override fun neg(): LuaValue {
        return (org.basaltmc.luak.LuaInteger.Companion.valueOf(-v))!!
    }
    ...
    override fun add(lhs: Long): LuaValue {
        return (org.basaltmc.luak.LuaInteger.Companion.valueOf(lhs + v.toLong()))!!
    }
    ...
    override fun sub(rhs: Long): LuaValue {
        return (org.basaltmc.luak.LuaInteger.Companion.valueOf(v - rhs))!!
    }
    ...
    override fun div(rhs: LuaValue): LuaValue {
        ...
        val other: LuaValue = rhs.tonumber()
        if (other.isnil()) return arithmt(org.basaltmc.luak.LuaValue.Companion.DIV, rhs)
    ...
    override fun mod(rhs: LuaValue): LuaValue {
        val other: LuaValue = rhs.tonumber()
        if (other.isnil()) return arithmt(org.basaltmc.luak.LuaValue.Companion.MOD, rhs)
    ...
    override fun mod(rhs: Long): LuaValue {
        return (org.basaltmc.luak.LuaInteger.Companion.valueOf(luaIntegerMod(v, rhs)))!!
    }
    ...
    companion object {
        ...
        init {
            for (i in 0..511) {
                org.basaltmc.luak.LuaInteger.Companion.intValues[i] = org.basaltmc.luak.LuaInteger((i - 256).toLong())
            }
        }

        fun valueOf(i: Int): LuaInteger? =
            org.basaltmc.luak.LuaInteger.Companion.valueOf(i.toLong())
        ...
        fun valueOf(l: Long): LuaInteger? {
            if (l in CACHE_LOW..CACHE_HIGH) {
                return org.basaltmc.luak.LuaInteger.Companion.intValues[(l - CACHE_LOW).toInt()]
            }
            return org.basaltmc.luak.LuaInteger(l)
        }
