...
import org.basaltmc.luak.io.DataOutputStream
...
class LuaString private constructor(
    ...
    private object RecentShortStrings {
        internal val recent_short_strings: Array<LuaString?>? =
            arrayOfNulls<LuaString>(org.basaltmc.luak.LuaString.Companion.RECENT_STRINGS_CACHE_SIZE)
    }
     ...
     */
    init {
        this.m_hashcode = org.basaltmc.luak.LuaString.Companion.hashCode(m_bytes, m_offset, m_length)
    ...
    override fun getmetatable(): LuaValue? {
        return org.basaltmc.luak.LuaString.Companion.s_metatable
    }
    ...
    override fun tojstring(): String {
        return org.basaltmc.luak.LuaString.Companion.decodeAsUtf8(m_bytes, m_offset, m_length)
    }
    ...
    override fun concatTo(lhs: LuaString): LuaValue {
        ...
        return org.basaltmc.luak.LuaString.Companion.valueUsing(b, 0, b.size)
    }
    ...
    override fun checkinteger(): LuaInteger? {
        return org.basaltmc.luak.LuaInteger.valueOf(checklong())
    }
    ...
    fun substring(beginIndex: Int, endIndex: Int): LuaString {
        ...
        return if (len >= m_length / 2) org.basaltmc.luak.LuaString.Companion.valueUsing(
            m_bytes,
            off,
            len
        ) else org.basaltmc.luak.LuaString.Companion.valueOf(m_bytes, off, len)
    }
    ...
    private fun byteseq(bytes: ByteArray, off: Int, len: Int): Boolean {
        return (m_length == len && org.basaltmc.luak.LuaString.Companion.equals(m_bytes, m_offset, bytes, off, len))
    }
    ...
    fun indexOf(s: LuaString, start: Int): Int {
        ...
        for (i in start..limit) {
            if (org.basaltmc.luak.LuaString.Companion.equals(m_bytes, m_offset + i, s.m_bytes, s.m_offset, slen)) return i
        }
        return -1
    }
    ...
    fun tonumber(base: Int): LuaValue? {
        val value: Long = org.basaltmc.luak.NumberParser.parseInteger(tojstring(), base) ?: return NIL
    ...
    private fun scannumeral(): LuaValue? {
        ...
        return org.basaltmc.luak.NumberParser.parse(tojstring())
    }
    ...
    fun scannumber(base: Int): Double {
        val value: Long = org.basaltmc.luak.NumberParser.parseInteger(tojstring(), base)
            ?: return Double.NaN
    ...
    companion object {
        ...
        fun valueOf(string: String): LuaString {
            ...
            val b = ByteArray(org.basaltmc.luak.LuaString.Companion.lengthAsUtf8(c))
            org.basaltmc.luak.LuaString.Companion.encodeToUtf8(c, c.size, b, 0)
            return org.basaltmc.luak.LuaString.Companion.valueUsing(b, 0, b.size)
        }
        ...
        fun valueOf(bytes: ByteArray, off: Int = 0, len: Int = bytes.size): LuaString {
            if (len > org.basaltmc.luak.LuaString.Companion.RECENT_STRINGS_MAX_LENGTH) return org.basaltmc.luak.LuaString.Companion.valueFromCopy(
                bytes,
                off,
                len
            )
            val hash: Int = org.basaltmc.luak.LuaString.Companion.hashCode(bytes, off, len)
            val bucket = hash and (org.basaltmc.luak.LuaString.Companion.RECENT_STRINGS_CACHE_SIZE - 1)
            val t: LuaString? = org.basaltmc.luak.LuaString.RecentShortStrings.recent_short_strings!![bucket]
            if (t != null && t.m_hashcode == hash && t.byteseq(bytes, off, len)) return t
            val s: LuaString = org.basaltmc.luak.LuaString.Companion.valueFromCopy(bytes, off, len)
            org.basaltmc.luak.LuaString.RecentShortStrings.recent_short_strings!![bucket] = s
            return s
        }
        ...
        private fun valueFromCopy(bytes: ByteArray?, off: Int, len: Int): LuaString {
            ...
            return org.basaltmc.luak.LuaString(copy, 0, len)
        }
        ...
        fun valueUsing(bytes: ByteArray, off: Int = 0, len: Int = bytes.size): LuaString {
            if (bytes.size > org.basaltmc.luak.LuaString.Companion.RECENT_STRINGS_MAX_LENGTH) return org.basaltmc.luak.LuaString(
                bytes,
                off,
                len
            )
            ...
            val t: LuaString? = org.basaltmc.luak.LuaString.RecentShortStrings.recent_short_strings!![bucket]
            if (t != null && t.m_hashcode == hash && t.byteseq(bytes, off, len)) return t
            val s: LuaString = org.basaltmc.luak.LuaString(bytes, off, len)
            org.basaltmc.luak.LuaString.RecentShortStrings.recent_short_strings!![bucket] = s
            return s
        }
        ...
        fun valueOf(bytes: CharArray, off: Int = 0, len: Int = bytes.size): LuaString {
            ...
            return org.basaltmc.luak.LuaString.Companion.valueUsing(b, 0, len)
        }
        ...
        fun equals(a: LuaString, i: Int, b: LuaString, j: Int, n: Int): Boolean {
            return org.basaltmc.luak.LuaString.Companion.equals(a.m_bytes, a.m_offset + i, b.m_bytes, b.m_offset + j, n)
        }
