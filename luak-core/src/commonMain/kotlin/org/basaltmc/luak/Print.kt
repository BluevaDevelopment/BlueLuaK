...
import org.basaltmc.luak.io.PrintStream
import org.basaltmc.luak.io.standardOutput
...
class Print : Lua() {
    ...
    companion object {
        ...
        fun printValue(ps: PrintStream, v: LuaValue?) {
            ...
            when (v.type()) {
                LuaValue.TSTRING -> org.basaltmc.luak.Print.Companion.printString(ps, v as LuaString)
        ...
        fun printConstant(ps: PrintStream, f: Prototype, i: Int) {
            val constants = f.k
            org.basaltmc.luak.Print.Companion.printValue(
                ps,
        ...
        fun printUpvalue(ps: PrintStream, u: Upvaldesc) {
            ps.print("${u.idx} ")
            org.basaltmc.luak.Print.Companion.printValue(ps, u.name)
        }
        ...
        fun printCode(f: Prototype) {
            ...
            val n = code.size
            while (pc < n) {
                pc = org.basaltmc.luak.Print.Companion.printOpCode(f, pc)
                org.basaltmc.luak.Print.Companion.ps.println()
                pc++
            }
        }
        ...
        fun printOpCode(f: Prototype, pc: Int): Int {
            return org.basaltmc.luak.Print.Companion.printOpCode(org.basaltmc.luak.Print.Companion.ps, f, pc)
        }
        ...
        fun printOpCode(ps: PrintStream, f: Prototype, pc: Int): Int {
            ...
            val line: Int = org.basaltmc.luak.Print.Companion.getline(f, pc)
            val upvalues = f.upvalues
            val protos = f.p
            ps.print("  " + (pc + 1) + "  ")
            if (line > 0) ps.print("[" + line + "]  ")
            else ps.print("[-]  ")
            if (o >= org.basaltmc.luak.Print.Companion.OPNAMES.size - 1) {
                ps.print("UNKNOWN_OP_" + o + "  ")
            } else {
                ps.print(org.basaltmc.luak.Print.Companion.OPNAMES[o].toString() + "  ")
                when (getOpMode(o)) {
                    iABC -> {
                        ps.print(a)
                ...
                when (o) {
                    OP_LOADK -> {
                        ps.print("  ; ")
                        org.basaltmc.luak.Print.Companion.printConstant(ps, f, bx)
                    }

                    OP_GETUPVAL, OP_SETUPVAL -> {
                        ps.print("  ; ")
                        if (upvalues != null && b < upvalues.size) {
                            org.basaltmc.luak.Print.Companion.printUpvalue(ps, upvalues[b]!!)
                        } else {
                    ...
                    OP_GETTABUP -> {
                        ...
                        ps.print(" ")
                        if (ISK(c)) org.basaltmc.luak.Print.Companion.printConstant(ps, f, INDEXK(c))
                        else ps.print("-")
                    }
                    ...
                    OP_SETTABUP -> {
                        ...
                        if (upvalues != null && a < upvalues.size) {
                            org.basaltmc.luak.Print.Companion.printUpvalue(ps, upvalues[a]!!)
                        } else {
                            ps.print("UNKNOWN_UPVALUE_" + a)
                        }
                        ps.print(" ")
                        if (ISK(b)) org.basaltmc.luak.Print.Companion.printConstant(ps, f, INDEXK(b))
                        else ps.print("-")
                        ps.print(" ")
                        if (ISK(c)) org.basaltmc.luak.Print.Companion.printConstant(ps, f, INDEXK(c))
                        else ps.print("-")
                    ...
                    OP_GETTABLE, OP_SELF -> if (ISK(c)) {
                        ps.print("  ; ")
                        org.basaltmc.luak.Print.Companion.printConstant(ps, f, INDEXK(c))
                    }
        ...
        fun printHeader(f: Prototype) {
            ...
            org.basaltmc.luak.Print.Companion.ps.print(
                ("\n%" + a + " <" + s + ":" + f.linedefined + ","
                        + f.lastlinedefined + "> (" + codeLen + " instructions, "
                        + codeLen * 4 + " bytes at " + org.basaltmc.luak.Print.Companion.id(f) + ")\n")
            )
            org.basaltmc.luak.Print.Companion.ps.print(
        ...
        fun printConstants(f: Prototype) {
            val k = f.k ?: return
            val n: Int = k.size
            org.basaltmc.luak.Print.Companion.ps.print("constants (" + n + ") for " + org.basaltmc.luak.Print.Companion.id(f) + ":\n")
            var i = 0
            while (i < n) {
                org.basaltmc.luak.Print.Companion.ps.print("  " + (i + 1) + "  ")
                org.basaltmc.luak.Print.Companion.printValue(org.basaltmc.luak.Print.Companion.ps, k[i])
                org.basaltmc.luak.Print.Companion.ps.print("\n")
                i++
            }
        }
        ...
        fun printLocals(f: Prototype) {
            ...
            org.basaltmc.luak.Print.Companion.ps.print("locals (" + n + ") for " + org.basaltmc.luak.Print.Companion.id(f) + ":\n")
            var i = 0
            while (i < n) {
                val lv = locvars[i]
                org.basaltmc.luak.Print.Companion.ps.println("  " + i + "  " + lv?.varname + " " + ((lv?.startpc ?: 0) + 1) + " " + ((lv?.endpc ?: 0) + 1))
                i++
            }
        }
        ...
        fun printUpValues(f: Prototype) {
            ...
            org.basaltmc.luak.Print.Companion.ps.print("upvalues (" + n + ") for " + org.basaltmc.luak.Print.Companion.id(f) + ":\n")
            var i = 0
            while (i < n) {
                org.basaltmc.luak.Print.Companion.ps.print("  " + i + "  " + upvalues[i] + "\n")
                i++
            }
        }
        ...
        fun print(prototype: Prototype) {
            org.basaltmc.luak.Print.Companion.printFunction(prototype, true)
        }
        ...
        fun printFunction(prototype: Prototype, full: Boolean) {
            ...
            org.basaltmc.luak.Print.Companion.printHeader(prototype)
            org.basaltmc.luak.Print.Companion.printCode(prototype)
            if (full) {
                org.basaltmc.luak.Print.Companion.printConstants(prototype)
                org.basaltmc.luak.Print.Companion.printLocals(prototype)
                org.basaltmc.luak.Print.Companion.printUpValues(prototype)
            }
            var i = 0
            while (i < n) {
                org.basaltmc.luak.Print.Companion.printFunction(protos[i]!!, full)
                i++
            }
        }
        ...
        private fun format(s: String, maxcols: Int) {
            val n: Int = s.length
            if (n > maxcols) org.basaltmc.luak.Print.Companion.ps.print(s.substring(0, maxcols))
            else {
                org.basaltmc.luak.Print.Companion.ps.print(s)
                var i = maxcols - n
                while (--i >= 0) {
                    org.basaltmc.luak.Print.Companion.ps.print(' ')
                }
        ...
        fun printState(cl: LuaClosure, pc: Int, stack: Array<LuaValue?>, top: Int, varargs: Varargs?) {
            ...
            val previous: PrintStream = org.basaltmc.luak.Print.Companion.ps
            val baos: ByteArrayOutputStream = ByteArrayOutputStream()
            org.basaltmc.luak.Print.Companion.ps = PrintStream(baos)
            org.basaltmc.luak.Print.Companion.printOpCode(cl.p, pc)
            org.basaltmc.luak.Print.Companion.ps.flush()
            org.basaltmc.luak.Print.Companion.ps.close()
            org.basaltmc.luak.Print.Companion.ps = previous
            org.basaltmc.luak.Print.Companion.format(baos.toByteArray().decodeToString(), 50)
            org.basaltmc.luak.Print.Companion.printStack(stack, top, varargs)
            org.basaltmc.luak.Print.Companion.ps.println()
        }
        ...
        fun printStack(stack: Array<LuaValue?>, top: Int, varargs: Varargs?) {
            ...
            for (i in stack.indices) {
                ...
                if (v == null) org.basaltmc.luak.Print.Companion.ps.print(org.basaltmc.luak.Print.Companion.STRING_FOR_NULL)
                else when (v.type()) {
                    LuaValue.TSTRING -> {
                    ...
                    LuaValue.TFUNCTION -> org.basaltmc.luak.Print.Companion.ps.print(v.tojstring())
                    LuaValue.TUSERDATA -> {
                        val o: Any? = v.touserdata()
                        if (o != null) {
                            var n: String = o::class.simpleName ?: "userdata"
                            n = n.substring(n.lastIndexOf('.') + 1)
                            org.basaltmc.luak.Print.Companion.ps.print(n.toString() + ": " + o.hashCode().toString(16))
                        } else {
                            org.basaltmc.luak.Print.Companion.ps.print(v.toString())
                        }
                    }

                    else -> org.basaltmc.luak.Print.Companion.ps.print(v.tojstring())
                }
                if (i + 1 == top) org.basaltmc.luak.Print.Companion.ps.print(']')
                org.basaltmc.luak.Print.Companion.ps.print(" | ")
            }
            org.basaltmc.luak.Print.Companion.ps.print(varargs)
        }
    }
}
