...
class Buffer {
    ...
    constructor(initialCapacity: Int = org.basaltmc.luak.Buffer.Companion.DEFAULT_CAPACITY) {
    ...
    constructor(value: LuaValue?) {
        bytes = org.basaltmc.luak.Buffer.Companion.NOBYTES
        offset = 0
        length = offset
        this.value = value
    }
    ...
    fun append(str: String): Buffer {
        ...
        val n: Int = LuaString.lengthAsUtf8(c)
        makeroom(0, n)
