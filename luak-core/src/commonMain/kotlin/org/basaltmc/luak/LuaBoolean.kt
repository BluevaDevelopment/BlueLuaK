...
class LuaBoolean internal constructor(
    ...
    override fun getmetatable(): LuaValue? {
        return org.basaltmc.luak.LuaBoolean.Companion.s_metatable
    }

    companion object {
        /** The singleton instance representing lua `true`  */
        val _TRUE: LuaBoolean = org.basaltmc.luak.LuaBoolean(true)

        /** The singleton instance representing lua `false`  */
        val _FALSE: LuaBoolean = org.basaltmc.luak.LuaBoolean(false)
