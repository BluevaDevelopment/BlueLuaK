 ...
 ******************************************************************************/
package org.basaltmc.luak.luajc
 ...
 * 
 * 
 * By default, when using [org.basaltmc.luak.lib.jvm.JvmPlatform] or
 * [org.basaltmc.luak.lib.jme.JmePlatform]
...
class LuaJC protected constructor() : Globals.Loader {
    ...
    override fun load(p: Prototype?, name: String?, globals: LuaValue?): LuaFunction? {
        ...
        if (p != null && usesInterpreterOnlyOpcodes(p)) {
            return LuaClosure(p, globals as? org.basaltmc.luak.Globals)
        }
    ...
    private fun usesInterpreterOnlyOpcodes(p: Prototype): Boolean {
        ...
        for (instruction in code) {
            when (org.basaltmc.luak.Lua.GET_OPCODE(instruction)) {
                org.basaltmc.luak.Lua.OP_TBC,
                org.basaltmc.luak.Lua.OP_ERRNNIL,
                org.basaltmc.luak.Lua.OP_FORPREP,
                -> return true
            }
        }
