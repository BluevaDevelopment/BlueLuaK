...
class VarargsTest : TestCase() {
    ...
    fun testVarargsMore() {
        ...
        a_g = LuaValue.varargsOf(
            kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(VarargsTest.Companion.A),
            org.basaltmc.luak.LuaValue.varargsOf(
        ...
        a_g = LuaValue.varargsOf(
            kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(
                ...
                VarargsTest.Companion.D,
                VarargsTest.Companion.E
            ), org.basaltmc.luak.LuaValue.varargsOf(VarargsTest.Companion.F, VarargsTest.Companion.G)
        )!!
        standardTestsA_G(a_g)
        a_g = LuaValue.varargsOf(
            kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(
