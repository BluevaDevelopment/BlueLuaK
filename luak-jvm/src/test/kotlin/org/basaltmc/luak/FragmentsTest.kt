...
import org.basaltmc.luak.lib.jvm.asLuaReader
import junit.framework.TestCase
import junit.framework.TestSuite
import org.basaltmc.luak.lib.jvm.JvmPlatform.debugGlobals
import org.basaltmc.luak.luajc.LuaJC.Companion.install
...
object FragmentsTest : TestSuite() {
    ...
    abstract class FragmentsTestCase constructor(val TEST_TYPE: Int) : TestCase() {
        ...
        fun testForloopParamUpvalues() {
            runFragment(
                LuaValue.varargsOf(
                    kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(
                        org.basaltmc.luak.LuaValue.valueOf(77),
                        org.basaltmc.luak.LuaValue.valueOf(1)
                    )
                )!!,
                "for n,p in ipairs({77}) do\n" +
                        "	print('n,p',n,p)\n" +
        ...
        fun testArgVarargsUseBoth() {
            runFragment(
                LuaValue.varargsOf(
                    kotlin.arrayOf<org.basaltmc.luak.LuaValue>(
                        org.basaltmc.luak.LuaValue.valueOf("a"),
                        org.basaltmc.luak.LuaValue.valueOf("b"),
                        org.basaltmc.luak.LuaValue.valueOf("c")
                    )
                )!!,
                "function v(arg,...)\n" +
                        "	return arg,...\n" +
        ...
        fun testMultiAssign() {
            ...
            runFragment(
                LuaValue.varargsOf(
                    kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(
                        org.basaltmc.luak.LuaValue.valueOf(111),
                        org.basaltmc.luak.LuaValue.valueOf(111),
                        org.basaltmc.luak.LuaValue.valueOf(111)
                    )
                )!!,
        ...
        fun testLocalFunctionDeclarations() {
            runFragment(
                LuaValue.varargsOf(
                    org.basaltmc.luak.LuaValue.valueOf("function"),
                    org.basaltmc.luak.LuaValue.valueOf("nil")
                )!!,
                "local function aaa()\n" +
                        "	return type(aaa)\n" +
                        "end\n" +
        ...
        fun testTestSimpleBinops() {
            runFragment(
                LuaValue.varargsOf(
                    kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(
                        org.basaltmc.luak.LuaValue.FALSE,
                        org.basaltmc.luak.LuaValue.FALSE,
                        org.basaltmc.luak.LuaValue.TRUE,
                        org.basaltmc.luak.LuaValue.TRUE,
                        org.basaltmc.luak.LuaValue.FALSE
                    )
                )!!,
        ...
        fun testReturnUpvalue() {
            runFragment(
                LuaValue.varargsOf(
                    kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(
                        org.basaltmc.luak.LuaValue.ONE,
                        org.basaltmc.luak.LuaValue.valueOf(5),
                    )
                )!!,
                "local a = 1\n" +
                        "local b\n" +
        ...
        fun testReadOnlyAndReadWriteUpvalues() {
            runFragment(
                LuaValue.varargsOf(
                    kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(
                        org.basaltmc.luak.LuaValue.valueOf(333),
                        org.basaltmc.luak.LuaValue.valueOf(222)
                    )
                )!!,
                "local a = 111\n" +
                        "local b = 222\n" +
        ...
        fun testNestedUpvalues() {
            runFragment(
                LuaValue.varargsOf(
                    kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(
                        org.basaltmc.luak.LuaValue.valueOf(5),
                        org.basaltmc.luak.LuaValue.valueOf(8),
                        org.basaltmc.luak.LuaValue.valueOf(9)
                    )
                )!!,
                "local x = 3\n" +
                        "local y = 5\n" +
        ...
        fun testErrorArgIsString() {
            runFragment(
                LuaValue.varargsOf(
                    org.basaltmc.luak.LuaValue.valueOf("string"),
                    org.basaltmc.luak.LuaValue.valueOf("c")
                )!!,
        ...
        fun testErrorArgIsNumber() {
            runFragment(
                LuaValue.varargsOf(
                    org.basaltmc.luak.LuaValue.valueOf("number"),
                    org.basaltmc.luak.LuaValue.valueOf(1L)
                )!!,
        ...
        fun testVarargBugReport() {
            runFragment(
                LuaValue.varargsOf(
                    kotlin.arrayOf<org.basaltmc.luak.LuaValue?>(
                        org.basaltmc.luak.LuaValue.valueOf(1),
                        org.basaltmc.luak.LuaValue.valueOf(2),
                        org.basaltmc.luak.LuaValue.valueOf(3)
                    )
                )!!,
