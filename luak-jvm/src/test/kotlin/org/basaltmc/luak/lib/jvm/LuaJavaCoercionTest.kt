...
import org.basaltmc.luak.*
import org.basaltmc.luak.lib.jvm.CoerceJavaToLua.coerce
import org.basaltmc.luak.lib.jvm.CoerceLuaToJava.coerce
import org.basaltmc.luak.lib.jvm.CoerceLuaToJava.getCoercion
import org.basaltmc.luak.lib.jvm.CoerceLuaToJava.inheritanceLevels
...
class LuaJavaCoercionTest : TestCase() {
    ...
    fun testExceptionMessage() {
        ...
        val vresult: Varargs = globals!!.get("load")!!.call(LuaValue.valueOf(script))!!
            .invoke(org.basaltmc.luak.LuaValue.NONE!!)!!
