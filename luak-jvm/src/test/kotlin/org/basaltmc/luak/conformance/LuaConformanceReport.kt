 ...
 ******************************************************************************/
package org.basaltmc.luak.conformance
 ...
 * ```
 *
 * or the `BLUELUAK_LUA_TESTSUITE` environment variable. Without it the report
...
class LuaConformanceReport {
    ...
    private fun sandbox(suite: File): Globals {
        ...
        globals.get("os")!!.set(
            "exit",
            object : org.basaltmc.luak.lib.VarArgFunction() {
                override fun invoke(args: org.basaltmc.luak.Varargs): org.basaltmc.luak.Varargs =
                    throw org.basaltmc.luak.LuaError("os.exit called under the conformance harness")
            },
        )
        return globals
    }
    ...
    private companion object {
        ...
        const val SUITE_ENVIRONMENT = "BLUELUAK_LUA_TESTSUITE"
