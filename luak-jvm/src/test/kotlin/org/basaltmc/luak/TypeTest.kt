...
import org.basaltmc.luak.lib.jvm.JvmPlatform.debugGlobals
...
class TypeTest : TestCase() {
    ...
    private val somefunc: LuaFunction = object : ZeroArgFunction() {
    ...
    fun testToByte() {
        ...
        TestCase.assertEquals(sampledouble.toInt().toByte(), doubledouble.tobyte())
        ...
        TestCase.assertEquals(sampledouble.toInt().toByte(), stringdouble.tobyte())
    ...
    fun testToChar() {
        ...
        TestCase.assertEquals(sampleint.toChar().code, intint.tochar().code)
        TestCase.assertEquals(Char(samplelong.toUShort()).code, longdouble.tochar().code)
        TestCase.assertEquals(sampledouble.toInt().toChar().code, doubledouble.tochar().code)
        TestCase.assertEquals(0.toChar(), stringstring.tochar())
        TestCase.assertEquals(sampleint.toChar().code, stringint.tochar().code)
        TestCase.assertEquals(Char(samplelong.toUShort()).code, stringlong.tochar().code)
        TestCase.assertEquals(sampledouble.toInt().toChar().code, stringdouble.tochar().code)
    ...
    fun testToDouble() {
        ...
        assertEquals(0.0, stringstring.todouble())
    ...
    fun testToFloat() {
        ...
        assertEquals(0f, stringstring.tofloat())
    ...
    fun testToInt() {
        ...
        TestCase.assertEquals(0 as Int, stringstring.toint())
    ...
    fun testToLong() {
        ...
        TestCase.assertEquals(0L, stringstring.tolong())
    ...
    fun testToShort() {
        ...
        TestCase.assertEquals(sampledouble.toInt().toShort(), doubledouble.toshort())
        ...
        TestCase.assertEquals(sampledouble.toInt().toShort(), stringdouble.toshort())
    ...
    fun testToString() {
        ...
        TestCase.assertEquals(samplelong.toString() + ".0", longdouble.tojstring())
    ...
    fun testOptBoolean() {
        ...
        throwsError(zero, "optboolean", Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(intint, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(longdouble, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(doubledouble, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(somefunc, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(someclosure, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(stringstring, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(stringint, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(stringlong, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(stringdouble, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(thread, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(table, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(userdataobj, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
        throwsError(userdatacls, "optboolean", kotlin.Boolean::class.javaPrimitiveType, Boolean.FALSE)
    }
    ...
    fun testOptInt() {
        ...
        // A float with a fractional part denotes no integer, whether it comes
        // as a number or as the text of one.
        throwsError(doubledouble, "optint", Int::class.javaPrimitiveType!!, 33)
        ...
        throwsError(stringdouble, "optint", Int::class.javaPrimitiveType!!, 33)
    ...
    fun testOptInteger() {
        ...
        // A float with a fractional part denotes no integer, whether it comes
        // as a number or as the text of one.
        throwsError(doubledouble, "optinteger", LuaInteger::class.java, LuaValue.valueOf(33))
        ...
        throwsError(stringdouble, "optinteger", LuaInteger::class.java, LuaValue.valueOf(33))
    ...
    fun testOptLong() {
        ...
        // A float with a fractional part denotes no integer, whether it comes
        // as a number or as the text of one.
        throwsError(doubledouble, "optlong", Long::class.javaPrimitiveType!!, 33L)
        ...
        throwsError(stringdouble, "optlong", Long::class.javaPrimitiveType!!, 33L)
    ...
    fun testOptLuaString() {
        ...
        assertEquals(
            LuaValue.valueOf(samplelong.toString() + ".0"),
            longdouble.optstring(LuaValue.valueOf("xyz")),
        )
    ...
    fun testOptUserdataClass() {
        ...
        try {
            ...
            TestCase.assertEquals("org.basaltmc.luak.TypeTest.MyData expected, got userdata", le.message)
        }
    }
    ...
    fun testCheckInt() {
        ...
        // A float with a fractional part denotes no integer, so asking for one
        // is an error rather than a silent truncation.
        throwsErrorReq(doubledouble, "checkint")
    ...
    fun testCheckInteger() {
        ...
        // The whole 64-bit value, not the low 32 bits it used to be cut to.
    ...
    fun testCheckLong() {
        ...
        // A float with a fractional part denotes no integer, so asking for one
        // is an error rather than a silent truncation.
        throwsErrorReq(doubledouble, "checklong")
    ...
    fun testCheckLuaString() {
        ...
        assertEquals(LuaValue.valueOf(samplelong.toString() + ".0"), longdouble.checkstring())
