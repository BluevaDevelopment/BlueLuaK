...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-26.6-blue">
...
dependencies {
    implementation("net.blueva:blueluak-jvm:26.6")
}
```
...
Add the `repo.blueva.net/releases` repository shown above at the project level, then depend on the shared `net.blueva:blueluak-core:26.6
...
kotlin {
    ...
    sourceSets {
        commonMain {
            dependencies {
                implementation("net.blueva:blueluak-core:26.6")
            }
        }
    }
}
