 ...
 * unique set of classes for BlueLuaK classes.
 * <P>
...
class LuaClassLoader : ClassLoader() {
    ...
    companion object {
        /** String describing the BlueLuaK packages to consider part of the user classes  */
         ...
         * <P>
         * The [Launcher] that is returned will be a pristine BlueLuaK vm
