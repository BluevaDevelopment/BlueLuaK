 ...
 * <pre> `Globals globals = new Globals(); globals.load(new JvmBaseLib()); globals.load(new PackageLib()); globals.load(new JvmIoLib()); globals.get("io").get("write").call(LuaValue.valueOf("hello, world\n")); ` </pre>
 * 
