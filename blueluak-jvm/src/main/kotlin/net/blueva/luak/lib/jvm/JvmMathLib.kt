 ...
 * <pre> `Globals globals = new Globals(); globals.load(new JvmBaseLib()); globals.load(new PackageLib()); globals.load(new JvmMathLib()); System.out.println( globals.get("math").get("sqrt").call( LuaValue.valueOf(2) ) ); ` </pre>
 * 
