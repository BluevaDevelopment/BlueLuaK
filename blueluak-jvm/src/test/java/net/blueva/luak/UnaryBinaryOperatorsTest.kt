...
class UnaryBinaryOperatorsTest : TestCase() {
    ...
    fun testNot() {
        val ia: LuaValue = LuaValue.valueOf(3)
        val da: LuaValue = LuaValue.valueOf(.25)
        val sa: LuaValue = LuaValue.valueOf("1.5")
        val ba: LuaValue = LuaValue.TRUE!!
        val bb: LuaValue = LuaValue.FALSE!!
    ...
    fun testNeg() {
        val ia: LuaValue = LuaValue.valueOf(3)
        val ib: LuaValue = LuaValue.valueOf(-4)
        val da: LuaValue = LuaValue.valueOf(.25)
        val db: LuaValue = LuaValue.valueOf(-.5)
        val sa: LuaValue = LuaValue.valueOf("1.5")
        val sb: LuaValue = LuaValue.valueOf("-2.0")
    ...
    fun testDoublesBecomeInts() {
        ...
        val sa: LuaValue = LuaValue.valueOf("3.0")
        val sb: LuaValue = LuaValue.valueOf("3")
    ...
    fun testEqualsInt() {
        val ia: LuaValue = LuaInteger.valueOf(345)!!
        val ib: LuaValue = LuaInteger.valueOf(345)!!
        val ic: LuaValue = LuaInteger.valueOf(-345)!!
    ...
    fun testEqualsDouble() {
        val da: LuaValue = LuaDouble.valueOf(345.5)!!
        val db: LuaValue = LuaDouble.valueOf(345.5)!!
        val dc: LuaValue = LuaDouble.valueOf(-345.5)!!
    ...
    fun testEqInt() {
        val ia: LuaValue = LuaInteger.valueOf(345)!!
        val ib: LuaValue = LuaInteger.valueOf(345)!!
        val ic: LuaValue = LuaInteger.valueOf(-123)!!
        val sa: LuaValue = LuaString.valueOf("345")
        val sb: LuaValue = LuaString.valueOf("345")
        val sc: LuaValue = LuaString.valueOf("-345")
    ...
    fun testEqDouble() {
        ...
        val db: LuaValue = LuaDouble.valueOf(345.5)!!
        val dc: LuaValue = LuaDouble.valueOf(-345.5)!!
        val sa: LuaValue = LuaString.valueOf("345.5")
        val sb: LuaValue = LuaString.valueOf("345.5")
        val sc: LuaValue = LuaString.valueOf("-345.5")
    ...
    fun testEqualsMetatag() {
        val tru: LuaValue = LuaValue.TRUE!!
        val fal: LuaValue = LuaValue.FALSE!!
        val zer: LuaValue = LuaValue.ZERO!!
        val one: LuaValue? = LuaValue.ONE
        val abc: LuaValue = LuaValue.valueOf("abcdef").substring(0, 3)
        val def: LuaValue = LuaValue.valueOf("abcdef").substring(3, 6)
        val pi: LuaValue = LuaValue.valueOf(Math.PI)
        val ee: LuaValue = LuaValue.valueOf(Math.E)
        val tbl: LuaValue = LuaTable()
        val tbl2: LuaValue = LuaTable()
        val tbl3: LuaValue = LuaTable()
        val uda: LuaValue = LuaUserdata(Any())
        val udb: LuaValue = LuaUserdata(uda.touserdata()!!)
        val uda2: LuaValue = LuaUserdata(Any())
        val uda3: LuaValue = LuaUserdata(uda.touserdata()!!)
        val nilb: LuaValue? = LuaValue.valueOf(LuaValue.NIL.toboolean())
        val oneb: LuaValue? = LuaValue.valueOf(LuaValue.ONE!!.toboolean())
        assertEquals(LuaValue.FALSE, nilb)
        assertEquals(LuaValue.TRUE, oneb)
        val smt = LuaString.s_metatable
        try {
            // always return nil0
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_NIL))
            LuaNumber.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_NIL))
            LuaString.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_NIL))
            tbl.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_NIL)))
            tbl2.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_NIL)))
            uda.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_NIL)))
            udb.setmetatable(uda.getmetatable())
            uda2.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_NIL)))
            // diff metatag function
            tbl3.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_ONE)))
            uda3.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_ONE)))
            ...
            LuaNumber.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_ONE))
            LuaString.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_ONE))
            tbl.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_ONE)))
            tbl2.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_ONE)))
            uda.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_ONE)))
            udb.setmetatable(uda.getmetatable())
            uda2.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_ONE)))
            // diff metatag function
            tbl3.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_NIL)))
            uda3.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.EQ, RETURN_NIL)))
    ...
    fun testAdd() {
        val ia: LuaValue = LuaValue.valueOf(111)
        val ib: LuaValue = LuaValue.valueOf(44)
        val da: LuaValue = LuaValue.valueOf(55.25)
        val db: LuaValue = LuaValue.valueOf(3.5)
        val sa: LuaValue = LuaValue.valueOf("22.125")
        val sb: LuaValue = LuaValue.valueOf("7.25")
    ...
    fun testPow() {
        val ia: LuaValue = LuaValue.valueOf(3)
        val ib: LuaValue = LuaValue.valueOf(4)
        val da: LuaValue = LuaValue.valueOf(4.0)
        val db: LuaValue = LuaValue.valueOf(.5)
        val sa: LuaValue = LuaValue.valueOf("1.5")
        val sb: LuaValue = LuaValue.valueOf("2.0")
        ...
        // like kinds
        assertEquals(3.0.pow(4.0), ia.pow(ib).todouble())
        assertEquals(4.0.pow(.5), da.pow(db).todouble())
        assertEquals(1.5.pow(2.0), sa.pow(sb).todouble())


        // unlike kinds
        assertEquals(3.0.pow(4.0), ia.pow(da).todouble())
        assertEquals(4.0.pow(3.0), da.pow(ia).todouble())
        assertEquals(3.0.pow(1.5), ia.pow(sa).todouble())
        assertEquals(1.5.pow(3.0), sa.pow(ia).todouble())
        assertEquals(4.0.pow(1.5), da.pow(sa).todouble())
        assertEquals(1.5.pow(4.0), sa.pow(da).todouble())
    }
    ...
    fun testArithErrors() {
        ...
        val ops = arrayOf<String?>("add", "sub", "mul", "div", "mod", "pow")
        val vals = arrayOf<LuaValue?>(LuaValue.NIL, LuaValue.TRUE, LuaValue.tableOf())
        val numerics = arrayOf<LuaValue?>(LuaValue.valueOf(111), LuaValue.valueOf(55.25), LuaValue.valueOf("22.125"))
    ...
    fun testArithMetatag() {
        ...
        try {
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.ADD, RETURN_LHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.SUB, RETURN_LHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.MUL, RETURN_LHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.DIV, RETURN_LHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.POW, RETURN_LHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.MOD, RETURN_LHS))
            ...
            // always use right argument
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.ADD, RETURN_RHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.SUB, RETURN_RHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.MUL, RETURN_RHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.DIV, RETURN_RHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.POW, RETURN_RHS))
            ...
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.MOD, RETURN_RHS))
    ...
    fun testArithMetatagNumberTable() {
        val zero: LuaValue = LuaValue.ZERO!!
        val one: LuaValue? = LuaValue.ONE
        val tbl: LuaValue = LuaTable()
        ...
        tbl.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.ADD, RETURN_ONE)))
        ...
        tbl.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.SUB, RETURN_ONE)))
        ...
        tbl.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.MUL, RETURN_ONE)))
        ...
        tbl.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.DIV, RETURN_ONE)))
        ...
        tbl.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.POW, RETURN_ONE)))
        ...
        tbl.setmetatable(LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.MOD, RETURN_ONE)))
    ...
    fun testCompareStrings() {
        ...
        val sa: LuaValue = LuaValue.valueOf("-1.5")
        val sb: LuaValue = LuaValue.valueOf("-2.0")
        val sc: LuaValue = LuaValue.valueOf("1.5")
        val sd: LuaValue = LuaValue.valueOf("2.0")
    ...
    fun testCompareErrors() {
        ...
        val ops = arrayOf<String?>("lt", "lteq")
        val vals = arrayOf<LuaValue?>(LuaValue.NIL, LuaValue.TRUE, LuaValue.tableOf())
        val numerics = arrayOf<LuaValue?>(LuaValue.valueOf(111), LuaValue.valueOf(55.25), LuaValue.valueOf("22.125"))
        for (i in ops.indices) {
            for (j in vals.indices) {
    ...
    private fun checkCompareError(a: LuaValue, b: LuaValue, op: String, type: String) {
        try {
            ...
            val actual: String = ite.getTargetException().message!!
            if ((!actual.startsWith("attempt to compare")) || actual.indexOf(type) < 0) fail("(" + a.typename() + "," + op + "," + b.typename() + ") reported '" + actual + "'")
        } catch (e: Exception) {
            fail("(" + a.typename() + "," + op + "," + b.typename() + ") threw " + e)
        }
    }
    ...
    fun testCompareMetatag() {
        ...
        try {
            // always use left argument
            var mt: LuaValue = LuaValue.tableOf(
                arrayOf<LuaValue>(
    ...
    fun testLexicalComparison() {
        ...
        val baa: LuaValue = LuaValue.valueOf("baa")
        val Aaa: LuaValue = LuaValue.valueOf("Aaa")
        val aba: LuaValue = LuaValue.valueOf("aba")
        val aaaa: LuaValue = LuaValue.valueOf("aaaa")
        val t: LuaValue? = LuaValue.TRUE
        val f: LuaValue? = LuaValue.FALSE
    ...
    fun testBuffer() {
        val abc: LuaValue = LuaValue.valueOf("abcdefghi").substring(0, 3)
        val def: LuaValue = LuaValue.valueOf("abcdefghi").substring(3, 6)
        val ghi: LuaValue = LuaValue.valueOf("abcdefghi").substring(6, 9)
        val n123: LuaValue = LuaValue.valueOf(123)
    ...
    fun testConcatMetatag() {
        ...
        try {
            // always use left argument
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.CONCAT, RETURN_LHS))
            ...
            // always use right argument
            LuaBoolean.s_metatable = LuaValue.tableOf(arrayOf<LuaValue>(LuaValue.CONCAT, RETURN_RHS))
    ...
    private fun checkConcatError(a: LuaValue, b: LuaValue, op: String, type: String) {
        try {
            ...
            val actual: String = ite.getTargetException().message!!
            if ((!actual.startsWith("attempt to concatenate")) || actual.indexOf(type) < 0) fail("(" + a.typename() + "," + op + "," + b.typename() + ") reported '" + actual + "'")
        } catch (e: Exception) {
            fail("(" + a.typename() + "," + op + "," + b.typename() + ") threw " + e)
        }
    }
    ...
    companion object {
        private val RETURN_NIL: TwoArgFunction = object : TwoArgFunction() {
            override fun call(lhs: LuaValue?, rhs: LuaValue?): LuaValue? {
                return NIL
            }
        }

        private val RETURN_ONE: TwoArgFunction = object : TwoArgFunction() {
            override fun call(lhs: LuaValue?, rhs: LuaValue?): LuaValue? {
                return ONE
            }
        }
        ...
        private fun luaMod(x: Double, y: Double): Double {
            return if (y != 0.0) x - y * floor(x / y) else Double.NaN
        }

        private val RETURN_LHS: TwoArgFunction = object : TwoArgFunction() {
            override fun call(lhs: LuaValue?, rhs: LuaValue?): LuaValue? {
                return lhs
            }
        }

        private val RETURN_RHS: TwoArgFunction = object : TwoArgFunction() {
            override fun call(lhs: LuaValue?, rhs: LuaValue?): LuaValue? {
                return rhs
            }
        }
