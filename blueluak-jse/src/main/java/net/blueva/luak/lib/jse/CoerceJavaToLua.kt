...
object CoerceJavaToLua {
    ...
    init {
        ...
        COERCIONS.put(Boolean::class.java, boolCoercion)
        COERCIONS.put(Byte::class.java, intCoercion)
        COERCIONS.put(Char::class.java, charCoercion)
        COERCIONS.put(Short::class.java, intCoercion)
        COERCIONS.put(Int::class.java, intCoercion)
        COERCIONS.put(Long::class.java, doubleCoercion)
        COERCIONS.put(Float::class.java, doubleCoercion)
        COERCIONS.put(Double::class.java, doubleCoercion)
