 ...
 * <p>
 * This class is primarily used by the {@link net.blueva.luak.lib.jse.LuajavaLib}, 
 ...
 * <li>{@link LuaValue#listOf(LuaValue[], net.blueva.luak.Varargs)}</li>
 * <li>{@link LuaValue#tableOf(LuaValue[])}</li>
 * <li>{@link LuaValue#tableOf(LuaValue[], LuaValue[], net.blueva.luak.Varargs)}</li>
 * </ul>
 ...
 * @see net.blueva.luak.lib.jse.LuajavaLib
 */
