 ...
 * for example:
 * <pre> `LuaValue globals = JsePlatform.standardGlobals(); LuaJC.install(globals); LuaValue chunk = globals.load( "print('hello, world'), "main.lua"); System.out.println(chunk.isclosure());  // Will be false when LuaJC is working. chunk.call(); ` </pre>
 * 
 * 
