 ...
 * {@link net.blueva.luak.lib.jse.JsePlatform#standardGlobals()} or 
 * {@link net.blueva.luak.lib.jme.JmePlatform#standardGlobals()}, 
 ...
 * </ul>
 * <p>
 * There are alternate flows when the direct lua-to-Java bytecode compiling {@link net.blueva.luak.luajc.LuaJC} is used.
 * <ul>
 * <li>compile lua to lua bytecode using {@link Compiler} or load precompiled code using {@link Undumper}
 * <li>convert lua bytecode to equivalent Java bytecode using {@link net.blueva.luak.luajc.LuaJC} that implements {@link Loader} directly
 * </ul>
 * 
 * <h3>Java Field</h3>
 ...
 * When using {@link net.blueva.luak.lib.jse.JsePlatform} or {@link net.blueva.luak.lib.jme.JmePlatform}, 
