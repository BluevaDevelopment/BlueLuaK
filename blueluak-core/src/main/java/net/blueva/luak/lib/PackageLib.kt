 ...
 * <pre> `Globals globals = JsePlatform.standardGlobals(); System.out.println( globals.get("require").call"foo") ); ` </pre>
 * 
 * 
 * To instantiate and use it directly,
 * link it into your globals table via [LuaValue.load] using code such as:
 * <pre> `Globals globals = new Globals(); globals.load(new JseBaseLib()); globals.load(new PackageLib()); System.out.println( globals.get("require").call("foo") ); ` </pre>
 * <h3>Limitations</h3>
 ...
 * as outlined in the [BaseLib] and [net.blueva.luak.lib.jse.JseBaseLib] documentation.
 * 
 * 
 * @see LibFunction
 * 
...
class PackageLib : TwoArgFunction() {
    ...
    fun call(modname: LuaValue?, env: LuaValue): LuaValue {
        ...
        globals.set("require", net.blueva.luak.lib.PackageLib.require())
        package_ = LuaTable()
        ...
        package_.set(net.blueva.luak.lib.PackageLib.Companion._SEARCHPATH, net.blueva.luak.lib.PackageLib.searchpath())
        val searchers: LuaTable = LuaTable()
        searchers.set(1, net.blueva.luak.lib.PackageLib.preload_searcher().also { preload_searcher = it })
        searchers.set(2, net.blueva.luak.lib.PackageLib.lua_searcher().also { lua_searcher = it })
