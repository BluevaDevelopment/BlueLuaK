 ...
 * {@link net.blueva.luak.lib.jse.JseIoLib} for the JSE platform, and
 * {@link net.blueva.luak.lib.jme.JmeIoLib} for the JME platform.
 * <p>
 ...
 * {@link net.blueva.luak.lib.jse.JsePlatform#standardGlobals()} or {@link net.blueva.luak.lib.jme.JmePlatform#standardGlobals()}
 * <pre> {@code
 * Globals globals = JsePlatform.standardGlobals();
 * globals.get("io").get("write").call(LuaValue.valueOf("hello, world\n"));
 * } </pre>
 * In this example the platform-specific {@link net.blueva.luak.lib.jse.JseIoLib} library will be loaded, which will include
 * the base functionality provided by this class, whereas the {@link net.blueva.luak.lib.jse.JsePlatform} would load the
 * {@link net.blueva.luak.lib.jse.JseIoLib}.
 * <p>
