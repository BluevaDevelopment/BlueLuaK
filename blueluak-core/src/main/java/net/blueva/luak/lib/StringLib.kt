 ...
 * <pre> `Globals globals = JsePlatform.standardGlobals(); System.out.println( globals.get("string").get("upper").call( LuaValue.valueOf("abcde") ) ); ` </pre>
 * 
 * 
 * To instantiate and use it directly,
 * link it into your globals table via [LuaValue.load] using code such as:
 * <pre> `Globals globals = new Globals(); globals.load(new JseBaseLib()); globals.load(new PackageLib()); globals.load(new JseStringLib()); System.out.println( globals.get("string").get("upper").call( LuaValue.valueOf("abcde") ) ); ` </pre>
 * 
 * 
        ...
        init {
            ...
            for (i in 0..127) {
                ...
                if ((c >= 'a' && c <= 'f') || (c >= 'A' && c <= 'F') || (c >= '0' && c <= '9')) {
                    net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE[i] =
                        net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE[i].toInt() or net.blueva.luak.lib.StringLib.Companion.MASK_HEXDIGIT.toInt()
                }
                if ((c >= '!' && c <= '/') || (c >= ':' && c <= '@') || (c >= '[' && c <= '`') || (c >= '{' && c <= '~')) {
                    net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE[i] =
                        net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE[i].toInt() or net.blueva.luak.lib.StringLib.Companion.MASK_PUNCT.toInt()
                }
                if ((net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE[i].toInt() and (net.blueva.luak.lib.StringLib.Companion.MASK_LOWERCASE.toInt() or net.blueva.luak.lib.StringLib.Companion.MASK_UPPERCASE.toInt())) != 0) {
                    net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE[i] =
                        net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE[i].toInt() or net.blueva.luak.lib.StringLib.Companion.MASK_ALPHA.toInt()
                }
            }
            ...
            net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE['\r'.code] =
                net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE['\r'.code].toInt() or net.blueva.luak.lib.StringLib.Companion.MASK_SPACE.toInt()
            net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE['\n'.code] =
                net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE['\n'.code].toInt() or net.blueva.luak.lib.StringLib.Companion.MASK_SPACE.toInt()
            net.blueva.luak.lib.StringLib.Companion.CHAR_TABLE['\t'.code] =
