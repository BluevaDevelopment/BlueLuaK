...
* {@link net.blueva.luak.compiler.LuaC} compiler.
* <p>
...
* have been installed.
* <p>
* By default, when using {@link net.blueva.luak.lib.jse.JsePlatform} or
* {@link net.blueva.luak.lib.jme.JmePlatform}
* to construct globals, the {@link LoadState} default undumper is installed
* as the default {@link Globals.Undumper}.
* <p>
* 
* A lua binary file is created via the {@link net.blueva.luak.compiler.DumpState} class
:
* <pre> {@code
* Globals globals = JsePlatform.standardGlobals();
* Prototype p = globals.compilePrototype(new StringReader("print('hello, world')"), "main.lua");
* ByteArrayOutputStream o = new ByteArrayOutputStream();
* net.blueva.luak.compiler.DumpState.dump(p, o, false);
